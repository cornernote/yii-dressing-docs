<?php
$this->pageTitle = $this->pageHeading = 'CMissingTranslationEvent';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CMissingTranslationEvent';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CMissingTranslationEvent &raquo;
...
CMissingTranslationEvent represents the parameter for the <?php echo CHtml::link('onMissingTranslation', array('/site/doc', 'view' => 'CMessageSource', '#' => 'onMissingTranslation')); ?> event.</div>
<a name="properties"></a>
...
<tr id="category">
  <td><?php echo CHtml::link('category', array('/site/doc', 'view' => 'CMissingTranslationEvent', '#' => 'category-detail')); ?></td>
  <td>string</td>
  <td>the category that the message belongs to</td>
  <td>CMissingTranslationEvent</td>
</tr>
...
<tr id="language">
  <td><?php echo CHtml::link('language', array('/site/doc', 'view' => 'CMissingTranslationEvent', '#' => 'language-detail')); ?></td>
  <td>string</td>
  <td>the ID of the language that the message is to be translated to</td>
  <td>CMissingTranslationEvent</td>
</tr>
<tr id="message">
  <td><?php echo CHtml::link('message', array('/site/doc', 'view' => 'CMissingTranslationEvent', '#' => 'message-detail')); ?></td>
  <td>string</td>
  <td>the message to be translated</td>
  <td>CMissingTranslationEvent</td>
</tr>
...
<tr id="__construct">
  <td><?php echo CHtml::link('__construct()', array('/site/doc', 'view' => 'CMissingTranslationEvent', '#' => '__construct-detail')); ?></td>
  <td>Constructor.</td>
  <td>CMissingTranslationEvent</td>
</tr>
...
<div class="detailHeader" id="category-detail">
category<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public string <b>$category</b>;</div>

<p>the category that the message belongs to</p>
...
<p>the ID of the language that the message is to be translated to</p>
...
public void <b>__construct</b>(mixed $sender, string $category, string $message, string $language)</div>
</td></tr>
<tr>
  <td class="paramNameCol">$sender</td>
  <td class="paramTypeCol">mixed</td>
  <td class="paramDescCol">sender of this event</td>
</tr>
<tr>
...
<tr>
  ...
  <td class="paramTypeCol">string</td>
  <td class="paramDescCol">the ID of the language that the message is to be translated to</td>
</tr>
</table>

<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\i18n\CMessageSource.php#L159">yii\i18n\CMessageSource.php#L159</a> (<b><a href="#" class="show">show</a></b>)
