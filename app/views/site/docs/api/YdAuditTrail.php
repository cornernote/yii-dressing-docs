...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/master/yii-dressing/master/src\models\YdAuditTrail.php">dressing\models\YdAuditTrail.php</a></td>
</tr>
<tr>
  <th>Authors</th>
...
<tr id="action">
  <td><?php echo CHtml::link('action', array('/site/doc', 'view' => 'YdAuditTrail', '#' => 'action-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdAuditTrail</td>
</tr>
...
<tr id="audit">
  <td><?php echo CHtml::link('audit', array('/site/doc', 'view' => 'YdAuditTrail', '#' => 'audit-detail')); ?></td>
  <td><?php echo CHtml::link('YdAudit', array('/site/doc', 'view' => 'YdAudit')); ?></td>
  <td></td>
  <td>YdAuditTrail</td>
</tr>
<tr id="audit_id">
  <td><?php echo CHtml::link('audit_id', array('/site/doc', 'view' => 'YdAuditTrail', '#' => 'audit_id-detail')); ?></td>
  <td>integer</td>
  <td></td>
  <td>YdAuditTrail</td>
</tr>
...
<tr id="created">
  <td><?php echo CHtml::link('created', array('/site/doc', 'view' => 'YdAuditTrail', '#' => 'created-detail')); ?></td>
  <td>datetime</td>
  <td></td>
  <td>YdAuditTrail</td>
</tr>
...
<tr id="field">
  <td><?php echo CHtml::link('field', array('/site/doc', 'view' => 'YdAuditTrail', '#' => 'field-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdAuditTrail</td>
</tr>
<tr id="id">
  <td><?php echo CHtml::link('id', array('/site/doc', 'view' => 'YdAuditTrail', '#' => 'id-detail')); ?></td>
  <td>integer</td>
  <td></td>
  <td>YdAuditTrail</td>
</tr>
...
<tr id="model">
  <td><?php echo CHtml::link('model', array('/site/doc', 'view' => 'YdAuditTrail', '#' => 'model-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdAuditTrail</td>
</tr>
<tr id="model_id">
  <td><?php echo CHtml::link('model_id', array('/site/doc', 'view' => 'YdAuditTrail', '#' => 'model_id-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdAuditTrail</td>
</tr>
...
<tr id="new_value">
  <td><?php echo CHtml::link('new_value', array('/site/doc', 'view' => 'YdAuditTrail', '#' => 'new_value-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdAuditTrail</td>
</tr>
...
<tr id="old_value">
  <td><?php echo CHtml::link('old_value', array('/site/doc', 'view' => 'YdAuditTrail', '#' => 'old_value-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdAuditTrail</td>
</tr>
...
<div class="detailHeader" id="action-detail">
...
<div class="detailHeader" id="audit_id-detail">
audit_id<span class="detailHeaderTag">
property
</span>
</div>
...
<div class="detailHeader" id="field-detail">
field<span class="detailHeaderTag">
property
</span>
</div>
...
<div class="detailHeader" id="new_value-detail">
new_value<span class="detailHeaderTag">
property
</span>
</div>
...
<div class="detailHeader" id="old_value-detail">
old_value<span class="detailHeaderTag">
property
</span>
</div>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/master/yii-dressing/master/src\models\YdAuditTrail.php#L140">dressing\models\YdAuditTrail.php#L140</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">getNewValueString</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">new_value</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
<p></p>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/master/yii-dressing/master/src\models\YdAuditTrail.php#L132">dressing\models\YdAuditTrail.php#L132</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">getOldValueString</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">old_value</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
<p></p>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/master/yii-dressing/master/src\models\YdAuditTrail.php#L54">dressing\models\YdAuditTrail.php#L54</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
