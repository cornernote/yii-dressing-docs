<?php
$this->pageTitle = $this->pageHeading = 'CFlexWidget';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CFlexWidget';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\web\widgets\CFlexWidget.php">yii\web\widgets\CFlexWidget.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
<br/><br/>
To use CFlexWidget, set <?php echo CHtml::link('name', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'name')); ?> to be the Flex application name
(without the .swf suffix), and set <?php echo CHtml::link('baseUrl', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'baseUrl')); ?> to be URL (without the ending slash)
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'actions')); ?>.</td>
  <td><?php echo CHtml::link('CWidget', array('/site/doc', 'view' => 'CWidget')); ?></td>
</tr>
<tr id="align">
  <td><?php echo CHtml::link('align', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'align-detail')); ?></td>
  <td>string</td>
  <td>align of the application region.</td>
  <td>CFlexWidget</td>
</tr>
<tr id="allowFullScreen">
  <td><?php echo CHtml::link('allowFullScreen', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'allowFullScreen-detail')); ?></td>
  <td>boolean</td>
  <td>whether to allow running the Flash in full screen mode.</td>
  <td>CFlexWidget</td>
</tr>
<tr id="allowScriptAccess">
  <td><?php echo CHtml::link('allowScriptAccess', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'allowScriptAccess-detail')); ?></td>
  <td>string</td>
  <td>the access method of the script.</td>
  <td>CFlexWidget</td>
</tr>
<tr id="altHtmlContent">
  <td><?php echo CHtml::link('altHtmlContent', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'altHtmlContent-detail')); ?></td>
  <td>string</td>
  <td>the HTML content to be displayed if Flash player is not installed.</td>
  <td>CFlexWidget</td>
</tr>
<tr id="baseUrl">
  <td><?php echo CHtml::link('baseUrl', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'baseUrl-detail')); ?></td>
  <td>string</td>
  <td>the base URL of the Flex application.</td>
  <td>CFlexWidget</td>
</tr>
<tr id="bgColor">
  <td><?php echo CHtml::link('bgColor', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'bgColor-detail')); ?></td>
  <td>string</td>
...
<tr id="enableHistory">
  <td><?php echo CHtml::link('enableHistory', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'enableHistory-detail')); ?></td>
  <td>boolean</td>
  <td>whether history should be enabled.</td>
  <td>CFlexWidget</td>
</tr>
<tr id="flashVars">
  <td><?php echo CHtml::link('flashVars', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'flashVars-detail')); ?></td>
  <td>array</td>
  <td>parameters to be passed to the Flex application.</td>
  <td>CFlexWidget</td>
</tr>
<tr id="flashVarsAsString">
  <td><?php echo CHtml::link('flashVarsAsString', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'flashVarsAsString-detail')); ?></td>
  <td>string</td>
  <td>Generates the properly quoted flash parameter string.</td>
  <td>CFlexWidget</td>
</tr>
<tr id="height">
  <td><?php echo CHtml::link('height', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'height-detail')); ?></td>
  <td>string</td>
...
<tr id="name">
  <td><?php echo CHtml::link('name', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'name-detail')); ?></td>
  <td>string</td>
...
<tr id="quality">
  <td><?php echo CHtml::link('quality', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'quality-detail')); ?></td>
  <td>string</td>
...
<tr id="width">
  <td><?php echo CHtml::link('width', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'width-detail')); ?></td>
  <td>string</td>
...
<tr id="getFlashVarsAsString">
  <td><?php echo CHtml::link('getFlashVarsAsString()', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'getFlashVarsAsString-detail')); ?></td>
  <td>Generates the properly quoted flash parameter string.</td>
  <td>CFlexWidget</td>
</tr>
...
<tr id="registerClientScript">
  <td><?php echo CHtml::link('registerClientScript()', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'registerClientScript-detail')); ?></td>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'run-detail')); ?></td>
...
<div class="signature">
public string <?php echo CHtml::link('<b>getFlashVarsAsString</b>', array('/site/doc', 'view' => 'CFlexWidget', '#' => 'getFlashVarsAsString')); ?>()</div>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\web\widgets\CFlexWidget.php#L114">yii\web\widgets\CFlexWidget.php#L114</a> (<b><a href="#" class="show">show</a></b>)
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\web\widgets\CFlexWidget.php#L98">yii\web\widgets\CFlexWidget.php#L98</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\web\widgets\CFlexWidget.php#L81">yii\web\widgets\CFlexWidget.php#L81</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
