<?php
$this->pageTitle = $this->pageHeading = 'CMysqlColumnSchema';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CMysqlColumnSchema';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CMysqlColumnSchema &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\db\schema\mysql\CMysqlColumnSchema.php">yii\db\schema\mysql\CMysqlColumnSchema.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
CMysqlColumnSchema class describes the column meta data of a MySQL table.</div>
<a name="properties"></a>
...
<tr id="extractDefault">
  <td><?php echo CHtml::link('extractDefault()', array('/site/doc', 'view' => 'CMysqlColumnSchema', '#' => 'extractDefault-detail')); ?></td>
  <td>Extracts the default value for the column.</td>
  <td>CMysqlColumnSchema</td>
</tr>
<tr id="extractLimit">
  <td><?php echo CHtml::link('extractLimit()', array('/site/doc', 'view' => 'CMysqlColumnSchema', '#' => 'extractLimit-detail')); ?></td>
  <td>Extracts size, precision and scale information from column's DB type.</td>
  <td>CMysqlColumnSchema</td>
</tr>
<tr id="extractType">
  <td><?php echo CHtml::link('extractType()', array('/site/doc', 'view' => 'CMysqlColumnSchema', '#' => 'extractType-detail')); ?></td>
