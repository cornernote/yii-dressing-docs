<?php
$this->pageTitle = $this->pageHeading = 'YdUserToRole';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'YdUserToRole';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/master/yii-dressing/master/src\models\YdUserToRole.php">dressing\models\YdUserToRole.php</a></td>
</tr>
<tr>
  <th>Authors</th>
...
<br/><br/>
This is the model class for table 'user_to_role'</div>
<a name="properties"></a>
...
<tr id="id">
  <td><?php echo CHtml::link('id', array('/site/doc', 'view' => 'YdUserToRole', '#' => 'id-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdUserToRole</td>
</tr>
...
<tr id="role_id">
  <td><?php echo CHtml::link('role_id', array('/site/doc', 'view' => 'YdUserToRole', '#' => 'role_id-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdUserToRole</td>
</tr>
...
<tr id="user_id">
  <td><?php echo CHtml::link('user_id', array('/site/doc', 'view' => 'YdUserToRole', '#' => 'user_id-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdUserToRole</td>
</tr>
...
<tr class="inherited" id="validators">
  ...
  <td>array</td>
  <td>Returns the validators applicable to the current <?php echo CHtml::link('scenario', array('/site/doc', 'view' => 'YdUserToRole', '#' => 'scenario')); ?>.</td>
  <td><?php echo CHtml::link('CModel', array('/site/doc', 'view' => 'CModel')); ?></td>
</tr>
</table>
</div>
...
<tr class="inherited" id="afterFindInternal">
  ...
  <td>Calls <?php echo CHtml::link('afterFind', array('/site/doc', 'view' => 'YdUserToRole', '#' => 'afterFind')); ?>.</td>
  <td><?php echo CHtml::link('CActiveRecord', array('/site/doc', 'view' => 'CActiveRecord')); ?></td>
</tr>
...
<tr class="inherited" id="createValidators">
  ...
  <td>Creates validator objects based on the specification in <?php echo CHtml::link('rules', array('/site/doc', 'view' => 'YdUserToRole', '#' => 'rules')); ?>.</td>
  <td><?php echo CHtml::link('CModel', array('/site/doc', 'view' => 'CModel')); ?></td>
</tr>
...
<tr id="model">
  <td><?php echo CHtml::link('model()', array('/site/doc', 'view' => 'YdUserToRole', '#' => 'model-detail')); ?></td>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/master/yii-dressing/master/src\models\YdUserToRole.php#L51">dressing\models\YdUserToRole.php#L51</a> (<b><a href="#" class="show">show</a></b>)
...
<tr><td colspan="3">
<div class="signature2">
public static YdUserToRole <b>model</b>(string $className='YdUserToRole')</div>
</td></tr>
<tr>
...
<tr>
  <td class="paramNameCol">{return}</td>
  <td class="paramTypeCol">YdUserToRole</td>
  <td class="paramDescCol">the static model class</td>
</tr>
</table>

<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/master/yii-dressing/master/src\models\YdUserToRole.php#L43">dressing\models\YdUserToRole.php#L43</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
