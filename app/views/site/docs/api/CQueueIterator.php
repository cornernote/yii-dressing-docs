<?php
$this->pageTitle = $this->pageHeading = 'CQueueIterator';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CQueueIterator';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\collections\CQueueIterator.php">yii\collections\CQueueIterator.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
CQueueIterator implements an iterator for <?php echo CHtml::link('CQueue', array('/site/doc', 'view' => 'CQueue')); ?>.
<br/><br/>
It allows CQueue to return a new iterator for traversing the items in the queue.</div>
<a name="properties"></a>
...
<tr id="__construct">
  <td><?php echo CHtml::link('__construct()', array('/site/doc', 'view' => 'CQueueIterator', '#' => '__construct-detail')); ?></td>
  <td>Constructor.</td>
  <td>CQueueIterator</td>
</tr>
<tr id="current">
  <td><?php echo CHtml::link('current()', array('/site/doc', 'view' => 'CQueueIterator', '#' => 'current-detail')); ?></td>
  <td>Returns the current array item.</td>
  <td>CQueueIterator</td>
</tr>
<tr id="key">
  <td><?php echo CHtml::link('key()', array('/site/doc', 'view' => 'CQueueIterator', '#' => 'key-detail')); ?></td>
  <td>Returns the key of the current array item.</td>
  <td>CQueueIterator</td>
</tr>
<tr id="next">
  <td><?php echo CHtml::link('next()', array('/site/doc', 'view' => 'CQueueIterator', '#' => 'next-detail')); ?></td>
  <td>Moves the internal pointer to the next array item.</td>
  <td>CQueueIterator</td>
</tr>
<tr id="rewind">
  <td><?php echo CHtml::link('rewind()', array('/site/doc', 'view' => 'CQueueIterator', '#' => 'rewind-detail')); ?></td>
  <td>Rewinds internal array pointer.</td>
  <td>CQueueIterator</td>
</tr>
<tr id="valid">
  <td><?php echo CHtml::link('valid()', array('/site/doc', 'view' => 'CQueueIterator', '#' => 'valid-detail')); ?></td>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\collections\CQueueIterator.php#L39">yii\collections\CQueueIterator.php#L39</a> (<b><a href="#" class="show">show</a></b>)
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\collections\CQueueIterator.php#L70">yii\collections\CQueueIterator.php#L70</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\collections\CQueueIterator.php#L60">yii\collections\CQueueIterator.php#L60</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\collections\CQueueIterator.php#L79">yii\collections\CQueueIterator.php#L79</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\collections\CQueueIterator.php#L50">yii\collections\CQueueIterator.php#L50</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\collections\CQueueIterator.php#L89">yii\collections\CQueueIterator.php#L89</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
