<?php
$this->pageTitle = $this->pageHeading = 'CContentDecorator';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CContentDecorator';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CContentDecorator &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\web\widgets\CContentDecorator.php">yii\web\widgets\CContentDecorator.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
is embedded within another layout. <?php echo CHtml::link('CBaseController', array('/site/doc', 'view' => 'CBaseController')); ?> defines a pair of
...
<br/><br/>
The property <?php echo CHtml::link('view', array('/site/doc', 'view' => 'CContentDecorator', '#' => 'view')); ?> specifies the name of the view that is used to
decorate the content. In the view, the content being decorated may be
accessed with variable <code>$content</code>.</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'CContentDecorator', '#' => 'actions')); ?>.</td>
...
<tr id="data">
  <td><?php echo CHtml::link('data', array('/site/doc', 'view' => 'CContentDecorator', '#' => 'data-detail')); ?></td>
  <td>array</td>
  <td>the variables (name=>value) to be extracted and made available in the decorative view.</td>
  <td>CContentDecorator</td>
</tr>
...
<tr id="view">
  <td><?php echo CHtml::link('view', array('/site/doc', 'view' => 'CContentDecorator', '#' => 'view-detail')); ?></td>
  <td>mixed</td>
  <td>the name of the view that will be used to decorate the captured content.</td>
  <td>CContentDecorator</td>
</tr>
...
<tr id="processOutput">
  <td><?php echo CHtml::link('processOutput()', array('/site/doc', 'view' => 'CContentDecorator', '#' => 'processOutput-detail')); ?></td>
...
<tr id="decorate">
  <td><?php echo CHtml::link('decorate()', array('/site/doc', 'view' => 'CContentDecorator', '#' => 'decorate-detail')); ?></td>
  <td>Decorates the content by rendering a view and embedding the content in it.</td>
  <td>CContentDecorator</td>
</tr>
</table>
</div>
...
<p>the variables (name=>value) to be extracted and made available in the decorative view.</p>
...
<div class="signature">
public mixed <b>$view</b>;</div>

<p>the name of the view that will be used to decorate the captured content.
...
<?php echo CHtml::link('default layout', array('/site/doc', 'view' => 'CWebModule', '#' => 'layout')); ?>.</p>


<h2>Method Details</h2>

<div class="detailHeader" id="decorate-detail">
decorate()
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\web\widgets\CContentDecorator.php#L52">yii\web\widgets\CContentDecorator.php#L52</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
This method decorates the output with the specified <?php echo CHtml::link('view', array('/site/doc', 'view' => 'CContentDecorator', '#' => 'view')); ?>.</p>
