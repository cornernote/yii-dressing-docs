<?php
$this->pageTitle = $this->pageHeading = 'CBreadcrumbs';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CBreadcrumbs';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/zii/widgets/CBreadcrumbs.php">yii/zii/widgets/CBreadcrumbs.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
<br/><br/>
To use CBreadcrumbs, one usually needs to configure its <?php echo CHtml::link('links', array('/site/doc', 'view' => 'CBreadcrumbs', '#' => 'links')); ?> property, which specifies
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'CBreadcrumbs', '#' => 'actions')); ?>.</td>
...
<tr id="htmlOptions">
  <td><?php echo CHtml::link('htmlOptions', array('/site/doc', 'view' => 'CBreadcrumbs', '#' => 'htmlOptions-detail')); ?></td>
  <td>array</td>
...
<tr id="inactiveLinkTemplate">
  <td><?php echo CHtml::link('inactiveLinkTemplate', array('/site/doc', 'view' => 'CBreadcrumbs', '#' => 'inactiveLinkTemplate-detail')); ?></td>
  <td>string</td>
...
<tr id="separator">
  <td><?php echo CHtml::link('separator', array('/site/doc', 'view' => 'CBreadcrumbs', '#' => 'separator-detail')); ?></td>
  <td>string</td>
...
<tr id="tagName">
  <td><?php echo CHtml::link('tagName', array('/site/doc', 'view' => 'CBreadcrumbs', '#' => 'tagName-detail')); ?></td>
  <td>string</td>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'CBreadcrumbs', '#' => 'run-detail')); ?></td>
...
If this property is not set, it defaults to a link pointing to <?php echo CHtml::link('CWebApplication::homeUrl', array('/site/doc', 'view' => 'CWebApplication', '#' => 'homeUrl')); ?> with label 'Home'.
...
create a URL). For more details, please refer to <?php echo CHtml::link('CHtml::link', array('/site/doc', 'view' => 'CHtml', '#' => 'link')); ?>.
...
is specified via <?php echo CHtml::link('homeLink', array('/site/doc', 'view' => 'CBreadcrumbs', '#' => 'homeLink')); ?> separately.
<br/><br/>
<pre>
array(
    'Sample post'=&gt;array('post/view', 'id'=&gt;12),
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/zii/widgets/CBreadcrumbs.php#L108">yii/zii/widgets/CBreadcrumbs.php#L108</a> (<b><a href="#" class="show">show</a></b>)
