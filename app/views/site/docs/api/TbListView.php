<?php
$this->pageTitle = $this->pageHeading = 'TbListView';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'TbListView';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src/widgets/TbListView.php">booster/widgets/TbListView.php</a></td>
</tr>
</table>

<div id="classDescription">
Bootstrap Zii list view.</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'TbListView', '#' => 'actions')); ?>.</td>
...
<tr class="inherited" id="emptyTagName">
  ...
  <td>string</td>
  <td>the HTML tag name for the container of the <?php echo CHtml::link('emptyText', array('/site/doc', 'view' => 'TbListView', '#' => 'emptyText')); ?> property.</td>
  <td><?php echo CHtml::link('CBaseListView', array('/site/doc', 'view' => 'CBaseListView')); ?></td>
</tr>
<tr class="inherited" id="emptyText">
  <td><?php echo CHtml::link('emptyText', array('/site/doc', 'view' => 'CBaseListView', '#' => 'emptyText-detail')); ?></td>
  <td>string</td>
  <td>the message to be displayed when <?php echo CHtml::link('dataProvider', array('/site/doc', 'view' => 'TbListView', '#' => 'dataProvider')); ?> does not have any data.</td>
  <td><?php echo CHtml::link('CBaseListView', array('/site/doc', 'view' => 'CBaseListView')); ?></td>
</tr>
...
<tr class="inherited" id="viewData">
  ...
  <td>array</td>
  <td>additional data to be passed to <?php echo CHtml::link('itemView', array('/site/doc', 'view' => 'TbListView', '#' => 'itemView')); ?> when rendering each data item.</td>
  <td><?php echo CHtml::link('CListView', array('/site/doc', 'view' => 'CListView')); ?></td>
</tr>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src/widgets/TbListView.php#L41">booster/widgets/TbListView.php#L41</a> (<b><a href="#" class="show">show</a></b>)
