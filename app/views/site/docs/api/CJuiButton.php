<?php
$this->pageTitle = $this->pageHeading = 'CJuiButton';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CJuiButton';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/zii/widgets/jui/CJuiButton.php">yii/zii/widgets/jui/CJuiButton.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
<br/><br/>
CJuiButton encapsulates the <a href="http://jqueryui.com/button/">JUI Button</a>
plugin.
<br/><br/>
...
<br/><br/>
By configuring the <?php echo CHtml::link('options', array('/site/doc', 'view' => 'CJuiButton', '#' => 'options')); ?> property, you may specify the options
that need to be passed to the JUI button plugin. Please refer to
the <a href="http://api.jqueryui.com/button/">JUI Button API</a> documentation
for possible options (name-value pairs) and
<a href="http://jqueryui.com/button/">JUI Button page</a> for general description
and demo.</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'CJuiButton', '#' => 'actions')); ?>.</td>
...
<tr id="buttonType">
  <td><?php echo CHtml::link('buttonType', array('/site/doc', 'view' => 'CJuiButton', '#' => 'buttonType-detail')); ?></td>
  <td>string</td>
  <td>The button type (possible types: submit, button, link, radio, checkbox, buttonset).</td>
  <td>CJuiButton</td>
</tr>
<tr id="caption">
  <td><?php echo CHtml::link('caption', array('/site/doc', 'view' => 'CJuiButton', '#' => 'caption-detail')); ?></td>
  <td>string</td>
...
<tr id="htmlTag">
  <td><?php echo CHtml::link('htmlTag', array('/site/doc', 'view' => 'CJuiButton', '#' => 'htmlTag-detail')); ?></td>
  <td>string</td>
  <td>The default html tag for the buttonset</td>
  <td>CJuiButton</td>
</tr>
...
<tr id="onclick">
  <td><?php echo CHtml::link('onclick', array('/site/doc', 'view' => 'CJuiButton', '#' => 'onclick-detail')); ?></td>
  <td>string</td>
  <td>The javascript function to be raised when this item is clicked (client event).</td>
  <td>CJuiButton</td>
</tr>
...
<tr id="url">
  <td><?php echo CHtml::link('url', array('/site/doc', 'view' => 'CJuiButton', '#' => 'url-detail')); ?></td>
  <td>mixed</td>
  <td>a URL or an action route that can be used to create a URL.</td>
  <td>CJuiButton</td>
</tr>
<tr id="value">
  <td><?php echo CHtml::link('value', array('/site/doc', 'view' => 'CJuiButton', '#' => 'value-detail')); ?></td>
  <td>mixed</td>
  <td>The value of the current item.</td>
  <td>CJuiButton</td>
</tr>
...
<tr id="init">
  <td><?php echo CHtml::link('init()', array('/site/doc', 'view' => 'CJuiButton', '#' => 'init-detail')); ?></td>
  <td>(non-PHPdoc)</td>
  <td>CJuiButton</td>
</tr>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'CJuiButton', '#' => 'run-detail')); ?></td>
  <td>(non-PHPdoc)</td>
  <td>CJuiButton</td>
</tr>
...
<tr class="inherited" id="registerScriptFile">
  ...
  <td>Registers a JavaScript file under <?php echo CHtml::link('scriptUrl', array('/site/doc', 'view' => 'CJuiButton', '#' => 'scriptUrl')); ?>.</td>
  <td><?php echo CHtml::link('CJuiWidget', array('/site/doc', 'view' => 'CJuiWidget')); ?></td>
</tr>
...
<p>The button type (possible types: submit, button, link, radio, checkbox, buttonset).
"submit" is used as default.</p>


<div class="detailHeader" id="caption-detail">
caption<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public string <b>$caption</b>;</div>

<p>The button text</p>


<div class="detailHeader" id="htmlTag-detail">
htmlTag<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public string <b>$htmlTag</b>;</div>

<p>The default html tag for the buttonset</p>


<div class="detailHeader" id="onclick-detail">
onclick<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public string <b>$onclick</b>;</div>

<p>The javascript function to be raised when this item is clicked (client event).</p>
...
<div class="signature">
public mixed <b>$url</b>;</div>

<p>a URL or an action route that can be used to create a URL. Used when a buttonType "link" is selected.
See normalizeUrl for more details about how to specify this parameter.</p>
...
<p>The value of the current item. Used only for "radio" and "checkbox"</p>
...
<h4>See Also</h4>
<ul>
	<li>framework/zii/widgets/jui/CJuiWidget::init()</li>
</ul>
</div>
