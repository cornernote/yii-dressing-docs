<?php
$this->pageTitle = $this->pageHeading = 'CStackIterator';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CStackIterator';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\collections\CStackIterator.php">yii\collections\CStackIterator.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
CStackIterator implements an iterator for <?php echo CHtml::link('CStack', array('/site/doc', 'view' => 'CStack')); ?>.
<br/><br/>
It allows CStack to return a new iterator for traversing the items in the stack.</div>
<a name="properties"></a>
...
<tr id="__construct">
  <td><?php echo CHtml::link('__construct()', array('/site/doc', 'view' => 'CStackIterator', '#' => '__construct-detail')); ?></td>
  <td>Constructor.</td>
  <td>CStackIterator</td>
</tr>
<tr id="current">
  <td><?php echo CHtml::link('current()', array('/site/doc', 'view' => 'CStackIterator', '#' => 'current-detail')); ?></td>
  <td>Returns the current array item.</td>
  <td>CStackIterator</td>
</tr>
<tr id="key">
  <td><?php echo CHtml::link('key()', array('/site/doc', 'view' => 'CStackIterator', '#' => 'key-detail')); ?></td>
  <td>Returns the key of the current array item.</td>
  <td>CStackIterator</td>
</tr>
<tr id="next">
  <td><?php echo CHtml::link('next()', array('/site/doc', 'view' => 'CStackIterator', '#' => 'next-detail')); ?></td>
  <td>Moves the internal pointer to the next array item.</td>
  <td>CStackIterator</td>
</tr>
<tr id="rewind">
  <td><?php echo CHtml::link('rewind()', array('/site/doc', 'view' => 'CStackIterator', '#' => 'rewind-detail')); ?></td>
  <td>Rewinds internal array pointer.</td>
  <td>CStackIterator</td>
</tr>
<tr id="valid">
  <td><?php echo CHtml::link('valid()', array('/site/doc', 'view' => 'CStackIterator', '#' => 'valid-detail')); ?></td>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\collections\CStackIterator.php#L39">yii\collections\CStackIterator.php#L39</a> (<b><a href="#" class="show">show</a></b>)
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\collections\CStackIterator.php#L70">yii\collections\CStackIterator.php#L70</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\collections\CStackIterator.php#L60">yii\collections\CStackIterator.php#L60</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\collections\CStackIterator.php#L79">yii\collections\CStackIterator.php#L79</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\collections\CStackIterator.php#L50">yii\collections\CStackIterator.php#L50</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\collections\CStackIterator.php#L89">yii\collections\CStackIterator.php#L89</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
