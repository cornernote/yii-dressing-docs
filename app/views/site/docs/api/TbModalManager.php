<?php
$this->pageTitle = $this->pageHeading = 'TbModalManager';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'TbModalManager';
?>
<div id="nav">
...
<tr>
  <th>Package</th>
  <td><?php echo CHtml::link('booster.widgets.modals', array('/site/doc', '#' => 'booster.widgets.modals')); ?></td>
</tr>
<tr>
  <th>Inheritance</th>
  <td>class TbModalManager &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbModalManager.php">booster\widgets\TbModalManager.php</a></td>
</tr>
</table>

<div id="classDescription">
## Bootstrap modal master widget.</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'TbModalManager', '#' => 'actions')); ?>.</td>
  <td><?php echo CHtml::link('CWidget', array('/site/doc', 'view' => 'CWidget')); ?></td>
</tr>
<tr id="autoOpen">
  <td><?php echo CHtml::link('autoOpen', array('/site/doc', 'view' => 'TbModalManager', '#' => 'autoOpen-detail')); ?></td>
  <td>boolean</td>
  <td>indicates whether to automatically open the modal when initialized.</td>
  <td>TbModalManager</td>
</tr>
...
<tr id="events">
  <td><?php echo CHtml::link('events', array('/site/doc', 'view' => 'TbModalManager', '#' => 'events-detail')); ?></td>
  <td>string[]</td>
  <td>the Javascript event handlers.</td>
  <td>TbModalManager</td>
</tr>
<tr id="fade">
  <td><?php echo CHtml::link('fade', array('/site/doc', 'view' => 'TbModalManager', '#' => 'fade-detail')); ?></td>
  <td>boolean</td>
  <td>indicates whether the modal should use transitions.</td>
  <td>TbModalManager</td>
</tr>
<tr id="htmlOptions">
  <td><?php echo CHtml::link('htmlOptions', array('/site/doc', 'view' => 'TbModalManager', '#' => 'htmlOptions-detail')); ?></td>
  <td>array</td>
...
<tr id="options">
  <td><?php echo CHtml::link('options', array('/site/doc', 'view' => 'TbModalManager', '#' => 'options-detail')); ?></td>
  <td>array</td>
...
<tr id="init">
  <td><?php echo CHtml::link('init()', array('/site/doc', 'view' => 'TbModalManager', '#' => 'init-detail')); ?></td>
...
<tr id="registerClientScript">
  <td><?php echo CHtml::link('registerClientScript()', array('/site/doc', 'view' => 'TbModalManager', '#' => 'registerClientScript-detail')); ?></td>
  <td>Registers required</td>
  <td>TbModalManager</td>
</tr>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'TbModalManager', '#' => 'run-detail')); ?></td>
...
<div class="detailHeader" id="autoOpen-detail">
autoOpen<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public boolean <b>$autoOpen</b>;</div>

<p>indicates whether to automatically open the modal when initialized. Defaults to 'false'.</p>
...
<p>indicates whether the modal should use transitions. Defaults to 'true'.</p>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbModalManager.php#L78">booster\widgets\TbModalManager.php#L78</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">run</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;echo&nbsp;</span><span style="color: #0000BB">CHtml</span><span style="color: #007700">::</span><span style="color: #0000BB">closeTag</span><span style="color: #007700">(</span><span style="color: #DD0000">'div'</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">registerClientScript</span><span style="color: #007700">(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">htmlOptions</span><span style="color: #007700">[</span><span style="color: #DD0000">'id'</span><span style="color: #007700">]);<br />}</span>
</span>
</code></div>
</div>
<p>Runs the widget.</p>
