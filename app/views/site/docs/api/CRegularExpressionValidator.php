<?php
$this->pageTitle = $this->pageHeading = 'CRegularExpressionValidator';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CRegularExpressionValidator';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CRegularExpressionValidator &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\validators\CRegularExpressionValidator.php">yii\validators\CRegularExpressionValidator.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
CRegularExpressionValidator validates that the attribute value matches to the specified <?php echo CHtml::link('regular expression', array('/site/doc', 'view' => 'CRegularExpressionValidator', '#' => 'pattern')); ?>.
You may invert the validation logic with help of the <?php echo CHtml::link('not', array('/site/doc', 'view' => 'CRegularExpressionValidator', '#' => 'not')); ?> property (available since 1.1.5).</div>
<a name="properties"></a>
...
<tr id="allowEmpty">
  <td><?php echo CHtml::link('allowEmpty', array('/site/doc', 'view' => 'CRegularExpressionValidator', '#' => 'allowEmpty-detail')); ?></td>
  <td>boolean</td>
  <td>whether the attribute value can be null or empty.</td>
  <td>CRegularExpressionValidator</td>
</tr>
...
<tr id="not">
  <td><?php echo CHtml::link('not', array('/site/doc', 'view' => 'CRegularExpressionValidator', '#' => 'not-detail')); ?></td>
  <td>boolean</td>
...
<tr id="pattern">
  <td><?php echo CHtml::link('pattern', array('/site/doc', 'view' => 'CRegularExpressionValidator', '#' => 'pattern-detail')); ?></td>
  <td>string</td>
  <td>the regular expression to be matched with</td>
  <td>CRegularExpressionValidator</td>
</tr>
...
<tr id="clientValidateAttribute">
  <td><?php echo CHtml::link('clientValidateAttribute()', array('/site/doc', 'view' => 'CRegularExpressionValidator', '#' => 'clientValidateAttribute-detail')); ?></td>
...
<tr id="validateAttribute">
  <td><?php echo CHtml::link('validateAttribute()', array('/site/doc', 'view' => 'CRegularExpressionValidator', '#' => 'validateAttribute-detail')); ?></td>
...
the regular expression defined via <?php echo CHtml::link('pattern', array('/site/doc', 'view' => 'CRegularExpressionValidator', '#' => 'pattern')); ?> should NOT match the attribute value.</p>
...
<p>the regular expression to be matched with</p>
