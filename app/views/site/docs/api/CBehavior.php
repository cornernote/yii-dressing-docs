...
<tr>
  <th>Subclasses</th>
  <td><?php echo CHtml::link('CConsoleCommandBehavior', array('/site/doc', 'view' => 'CConsoleCommandBehavior')); ?>, <?php echo CHtml::link('CModelBehavior', array('/site/doc', 'view' => 'CModelBehavior')); ?></td>
</tr>
<tr>
  <th>Source Code</th>
