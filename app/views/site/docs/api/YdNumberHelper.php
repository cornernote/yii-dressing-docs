...
<tr>
  <th>Inheritance</th>
  <td>class YdNumberHelper &raquo;
<?php echo CHtml::link('CComponent', array('/site/doc', 'view' => 'CComponent')); ?></td>
</tr>
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.1.0/yii-dressing/components/YdNumberHelper.php">dressing/components/YdNumberHelper.php</a></td>
</tr>
<tr>
  <th>Authors</th>
...
<tr id="average">
  <td><?php echo CHtml::link('average', array('/site/doc', 'view' => 'YdNumberHelper', '#' => 'average-detail')); ?></td>
  <td>bool|float</td>
  <td></td>
  <td>YdNumberHelper</td>
</tr>
<tr id="high">
  <td><?php echo CHtml::link('high', array('/site/doc', 'view' => 'YdNumberHelper', '#' => 'high-detail')); ?></td>
  <td>bool|float</td>
  <td></td>
  <td>YdNumberHelper</td>
</tr>
<tr id="low">
  <td><?php echo CHtml::link('low', array('/site/doc', 'view' => 'YdNumberHelper', '#' => 'low-detail')); ?></td>
  <td>bool|float</td>
  <td></td>
  <td>YdNumberHelper</td>
</tr>
<tr id="median">
  <td><?php echo CHtml::link('median', array('/site/doc', 'view' => 'YdNumberHelper', '#' => 'median-detail')); ?></td>
  <td>bool|float</td>
  <td></td>
  <td>YdNumberHelper</td>
</tr>
...
<div class="detailHeader" id="average-detail">
average<span class="detailHeaderTag">
property
 <em>read-only</em> </span>
</div>

<div class="signature">
public bool|float <?php echo CHtml::link('<b>getAverage</b>', array('/site/doc', 'view' => 'YdNumberHelper', '#' => 'getAverage')); ?>(array $array=array (
))</div>

<p></p>


<div class="detailHeader" id="high-detail">
high<span class="detailHeaderTag">
property
 <em>read-only</em> </span>
</div>

<div class="signature">
public bool|float <?php echo CHtml::link('<b>getHigh</b>', array('/site/doc', 'view' => 'YdNumberHelper', '#' => 'getHigh')); ?>(array $array=array (
))</div>

<p></p>


<div class="detailHeader" id="low-detail">
low<span class="detailHeaderTag">
property
 <em>read-only</em> </span>
</div>

<div class="signature">
public bool|float <?php echo CHtml::link('<b>getLow</b>', array('/site/doc', 'view' => 'YdNumberHelper', '#' => 'getLow')); ?>(array $array=array (
))</div>

<p></p>


<div class="detailHeader" id="median-detail">
median<span class="detailHeaderTag">
property
 <em>read-only</em> </span>
</div>

<div class="signature">
public bool|float <?php echo CHtml::link('<b>getMedian</b>', array('/site/doc', 'view' => 'YdNumberHelper', '#' => 'getMedian')); ?>(array $array=array (
))</div>
...
public bool|float <b>getAverage</b>(array $array=array (
))</div>
</td></tr>
<tr>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.1.0/yii-dressing/components/YdNumberHelper.php#L35">dressing/components/YdNumberHelper.php#L35</a> (<b><a href="#" class="show">show</a></b>)
...
<tr><td colspan="3">
<div class="signature2">
public bool|float <b>getHigh</b>(array $array=array (
))</div>
</td></tr>
<tr>
  <td class="paramNameCol">$array</td>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.1.0/yii-dressing/components/YdNumberHelper.php#L45">dressing/components/YdNumberHelper.php#L45</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<tr><td colspan="3">
<div class="signature2">
public bool|float <b>getLow</b>(array $array=array (
))</div>
</td></tr>
<tr>
  <td class="paramNameCol">$array</td>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.1.0/yii-dressing/components/YdNumberHelper.php#L55">dressing/components/YdNumberHelper.php#L55</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<tr><td colspan="3">
<div class="signature2">
public bool|float <b>getMedian</b>(array $array=array (
))</div>
</td></tr>
<tr>
  <td class="paramNameCol">$array</td>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.1.0/yii-dressing/components/YdNumberHelper.php#L20">dressing/components/YdNumberHelper.php#L20</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
