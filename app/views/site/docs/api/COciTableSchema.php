<?php
$this->pageTitle = $this->pageHeading = 'COciTableSchema';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'COciTableSchema';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class COciTableSchema &raquo;
...
COciTableSchema represents the metadata for an Oracle table.</div>
<a name="properties"></a>
...
<tr id="schemaName">
  <td><?php echo CHtml::link('schemaName', array('/site/doc', 'view' => 'COciTableSchema', '#' => 'schemaName-detail')); ?></td>
  <td>string</td>
  <td>name of the schema (database) that this table belongs to.</td>
  <td>COciTableSchema</td>
</tr>
