<?php
$this->pageTitle = $this->pageHeading = 'CMssqlTableSchema';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CMssqlTableSchema';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CMssqlTableSchema &raquo;
<?php echo CHtml::link('CDbTableSchema', array('/site/doc', 'view' => 'CDbTableSchema')); ?> &raquo;
<?php echo CHtml::link('CComponent', array('/site/doc', 'view' => 'CComponent')); ?></td>
</tr>
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/db/schema/mssql/CMssqlTableSchema.php">yii/db/schema/mssql/CMssqlTableSchema.php</a></td>
</tr>
<tr>
  <th>Authors</th>
...
CMssqlTableSchema represents the metadata for a MSSQL table.</div>
<a name="properties"></a>
...
<tr id="catalogName">
  <td><?php echo CHtml::link('catalogName', array('/site/doc', 'view' => 'CMssqlTableSchema', '#' => 'catalogName-detail')); ?></td>
  <td>string</td>
  <td>name of the catalog (database) that this table belongs to.</td>
  <td>CMssqlTableSchema</td>
</tr>
<tr class="inherited" id="columnNames">
...
<tr class="inherited" id="foreignKeys">
...
<tr id="schemaName">
  <td><?php echo CHtml::link('schemaName', array('/site/doc', 'view' => 'CMssqlTableSchema', '#' => 'schemaName-detail')); ?></td>
  <td>string</td>
  <td>name of the schema that this table belongs to.</td>
  <td>CMssqlTableSchema</td>
</tr>
<tr class="inherited" id="sequenceName">
...
<tr class="inherited" id="getColumn">
...
<tr class="inherited" id="getColumnNames">
...
<div class="detailHeader" id="catalogName-detail">
catalogName<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public string <b>$catalogName</b>;</div>

<p>name of the catalog (database) that this table belongs to.
Defaults to null, meaning no schema (or the current database).</p>


<div class="detailHeader" id="schemaName-detail">
schemaName<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public string <b>$schemaName</b>;</div>

<p>name of the schema that this table belongs to.
Defaults to null, meaning no schema (or the current database owner).</p>
