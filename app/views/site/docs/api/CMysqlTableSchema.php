<?php
$this->pageTitle = $this->pageHeading = 'CMysqlTableSchema';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CMysqlTableSchema';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CMysqlTableSchema &raquo;
...
CMysqlTableSchema represents the metadata for a MySQL table.</div>
<a name="properties"></a>
...
<tr id="schemaName">
  <td><?php echo CHtml::link('schemaName', array('/site/doc', 'view' => 'CMysqlTableSchema', '#' => 'schemaName-detail')); ?></td>
  <td>string</td>
  <td>name of the schema (database) that this table belongs to.</td>
  <td>CMysqlTableSchema</td>
</tr>
...
<p>name of the schema (database) that this table belongs to.
