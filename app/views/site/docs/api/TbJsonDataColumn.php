<?php
$this->pageTitle = $this->pageHeading = 'TbJsonDataColumn';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'TbJsonDataColumn';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class TbJsonDataColumn &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbJsonDataColumn.php">booster\widgets\TbJsonDataColumn.php</a></td>
</tr>
</table>
...
<br/><br/>
This column works specifically with TbJsonGridView.</div>
<a name="properties"></a>
...
<tr id="grid">
  <td><?php echo CHtml::link('grid', array('/site/doc', 'view' => 'TbJsonDataColumn', '#' => 'grid-detail')); ?></td>
  <td><?php echo CHtml::link('TbJsonGridView', array('/site/doc', 'view' => 'TbJsonGridView')); ?></td>
  <td></td>
  <td>TbJsonDataColumn</td>
</tr>
...
<tr class="inherited" id="value">
  ...
  <td>string</td>
  <td>a PHP expression that will be evaluated for every data cell using <?php echo CHtml::link('evaluateExpression', array('/site/doc', 'view' => 'TbJsonDataColumn', '#' => 'evaluateExpression')); ?> and whose result will be rendered
...
This is determined based on whether <?php echo CHtml::link('footer', array('/site/doc', 'view' => 'TbJsonDataColumn', '#' => 'footer')); ?> is set.</td>
  <td><?php echo CHtml::link('CGridColumn', array('/site/doc', 'view' => 'CGridColumn')); ?></td>
</tr>
...
<tr id="renderDataCellContent">
  <td><?php echo CHtml::link('renderDataCellContent()', array('/site/doc', 'view' => 'TbJsonDataColumn', '#' => 'renderDataCellContent-detail')); ?></td>
...
<tr><td colspan="3">
<div class="signature2">
public string|void <b>renderDataCellContent</b>(integer $row, mixed $data)</div>
</td></tr>
<tr>
  <td class="paramNameCol">$row</td>
  <td class="paramTypeCol">integer</td>
