<?php
$this->pageTitle = $this->pageHeading = 'CJuiResizable';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CJuiResizable';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/zii/widgets/jui/CJuiResizable.php">yii/zii/widgets/jui/CJuiResizable.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
<br/><br/>
CJuiResizable encapsulates the <a href="http://jqueryui.com/resizable/">JUI Resizable</a>
plugin.
<br/><br/>
...
<br/><br/>
By configuring the <?php echo CHtml::link('options', array('/site/doc', 'view' => 'CJuiResizable', '#' => 'options')); ?> property, you may specify the options
that need to be passed to the JUI Resizable plugin. Please refer to
the <a href="http://api.jqueryui.com/resizable/">JUI Resizable API</a> documentation
for possible options (name-value pairs) and
<a href="http://jqueryui.com/resizable/">JUI Resizable page</a> for general
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'CJuiResizable', '#' => 'actions')); ?>.</td>
...
<tr id="tagName">
  <td><?php echo CHtml::link('tagName', array('/site/doc', 'view' => 'CJuiResizable', '#' => 'tagName-detail')); ?></td>
  <td>string</td>
  <td>the name of the Resizable element.</td>
  <td>CJuiResizable</td>
</tr>
...
<tr id="init">
  <td><?php echo CHtml::link('init()', array('/site/doc', 'view' => 'CJuiResizable', '#' => 'init-detail')); ?></td>
  <td>Renders the open tag of the resizable element.</td>
  <td>CJuiResizable</td>
</tr>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'CJuiResizable', '#' => 'run-detail')); ?></td>
  <td>Renders the close tag of the resizable element.</td>
  <td>CJuiResizable</td>
</tr>
...
<tr class="inherited" id="registerScriptFile">
  ...
  <td>Registers a JavaScript file under <?php echo CHtml::link('scriptUrl', array('/site/doc', 'view' => 'CJuiResizable', '#' => 'scriptUrl')); ?>.</td>
  <td><?php echo CHtml::link('CJuiWidget', array('/site/doc', 'view' => 'CJuiWidget')); ?></td>
</tr>
...
<p>the name of the Resizable element. Defaults to 'div'.</p>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/zii/widgets/jui/CJuiResizable.php#L74">yii/zii/widgets/jui/CJuiResizable.php#L74</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<p>Renders the close tag of the resizable element.</p>
