<?php
$this->pageTitle = $this->pageHeading = 'TbTypeahead';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'TbTypeahead';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbTypeahead.php">booster\widgets\TbTypeahead.php</a></td>
</tr>
</table>

<div id="classDescription">
## Bootstrap typeahead widget.</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'TbTypeahead', '#' => 'actions')); ?>.</td>
...
<tr id="options">
  <td><?php echo CHtml::link('options', array('/site/doc', 'view' => 'TbTypeahead', '#' => 'options-detail')); ?></td>
  <td>array</td>
...
<tr id="init">
  <td><?php echo CHtml::link('init()', array('/site/doc', 'view' => 'TbTypeahead', '#' => 'init-detail')); ?></td>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'TbTypeahead', '#' => 'run-detail')); ?></td>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbTypeahead.php#L28">booster\widgets\TbTypeahead.php#L28</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">init</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">htmlOptions</span><span style="color: #007700">[</span><span style="color: #DD0000">'type'</span><span style="color: #007700">]&nbsp;=&nbsp;</span><span style="color: #DD0000">'text'</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">htmlOptions</span><span style="color: #007700">[</span><span style="color: #DD0000">'data-provide'</span><span style="color: #007700">]&nbsp;=&nbsp;</span><span style="color: #DD0000">'typeahead'</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">htmlOptions</span><span style="color: #007700">[</span><span style="color: #DD0000">'autocomplete'</span><span style="color: #007700">]&nbsp;=&nbsp;</span><span style="color: #DD0000">'off'</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
