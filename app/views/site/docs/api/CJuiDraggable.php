<?php
$this->pageTitle = $this->pageHeading = 'CJuiDraggable';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CJuiDraggable';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\zii\widgets\jui\CJuiDraggable.php">yii\zii\widgets\jui\CJuiDraggable.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
<br/><br/>
CJuiDraggable encapsulates the <a href="http://jqueryui.com/draggable/">JUI Draggable</a>
plugin.
<br/><br/>
...
<br/><br/>
By configuring the <?php echo CHtml::link('options', array('/site/doc', 'view' => 'CJuiDraggable', '#' => 'options')); ?> property, you may specify the options
that need to be passed to the JUI Draggable plugin. Please refer to
the <a href="http://api.jqueryui.com/draggable/">JUI Draggable API</a> documentation
for possible options (name-value pairs) and
<a href="http://jqueryui.com/draggable/">JUI Draggable page</a> for general
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'CJuiDraggable', '#' => 'actions')); ?>.</td>
...
<tr id="tagName">
  <td><?php echo CHtml::link('tagName', array('/site/doc', 'view' => 'CJuiDraggable', '#' => 'tagName-detail')); ?></td>
  <td>string</td>
  <td>the name of the Draggable element.</td>
  <td>CJuiDraggable</td>
</tr>
...
<tr id="init">
  <td><?php echo CHtml::link('init()', array('/site/doc', 'view' => 'CJuiDraggable', '#' => 'init-detail')); ?></td>
  <td>Renders the open tag of the draggable element.</td>
  <td>CJuiDraggable</td>
</tr>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'CJuiDraggable', '#' => 'run-detail')); ?></td>
  <td>Renders the close tag of the draggable element.</td>
  <td>CJuiDraggable</td>
</tr>
...
<tr class="inherited" id="registerScriptFile">
  ...
  <td>Registers a JavaScript file under <?php echo CHtml::link('scriptUrl', array('/site/doc', 'view' => 'CJuiDraggable', '#' => 'scriptUrl')); ?>.</td>
  <td><?php echo CHtml::link('CJuiWidget', array('/site/doc', 'view' => 'CJuiWidget')); ?></td>
</tr>
...
<p>the name of the Draggable element. Defaults to 'div'.</p>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\zii\widgets\jui\CJuiDraggable.php#L74">yii\zii\widgets\jui\CJuiDraggable.php#L74</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<p>Renders the close tag of the draggable element.</p>
