<?php
$this->pageTitle = $this->pageHeading = 'COutputEvent';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'COutputEvent';
?>
<div id="nav">
...
<br/><br/>
An event handler may retrieve the captured <?php echo CHtml::link('output', array('/site/doc', 'view' => 'COutputEvent', '#' => 'output')); ?> for further processing.</div>
<a name="properties"></a>
...
<tr id="output">
  <td><?php echo CHtml::link('output', array('/site/doc', 'view' => 'COutputEvent', '#' => 'output-detail')); ?></td>
  <td>string</td>
  <td>the output to be processed.</td>
  <td>COutputEvent</td>
</tr>
...
<tr id="__construct">
  <td><?php echo CHtml::link('__construct()', array('/site/doc', 'view' => 'COutputEvent', '#' => '__construct-detail')); ?></td>
  <td>Constructor.</td>
  <td>COutputEvent</td>
</tr>
...
output<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public string <b>$output</b>;</div>

<p>the output to be processed. The processed output should be stored back to this property.</p>
...
public void <b>__construct</b>(mixed $sender, string $output)</div>
</td></tr>
<tr>
...
<tr>
  ...
  <td class="paramDescCol">the output to be processed</td>
</tr>
</table>
