<?php
$this->pageTitle = $this->pageHeading = 'CPasswordHelper';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CPasswordHelper';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\utils\CPasswordHelper.php">yii\utils\CPasswordHelper.php</a></td>
</tr>
<tr>
  <th>Author</th>
  <td>Tom Worster &lt;fsb@thefsb.org&gt;</td>
</tr>
</table>
...
<tr id="generateSalt">
  <td><?php echo CHtml::link('generateSalt()', array('/site/doc', 'view' => 'CPasswordHelper', '#' => 'generateSalt-detail')); ?></td>
  <td>Generates a salt that can be used to generate a password hash.</td>
  <td>CPasswordHelper</td>
</tr>
<tr id="hashPassword">
  <td><?php echo CHtml::link('hashPassword()', array('/site/doc', 'view' => 'CPasswordHelper', '#' => 'hashPassword-detail')); ?></td>
  <td>Generate a secure hash from a password and a random salt.</td>
  <td>CPasswordHelper</td>
</tr>
<tr id="same">
  <td><?php echo CHtml::link('same()', array('/site/doc', 'view' => 'CPasswordHelper', '#' => 'same-detail')); ?></td>
  <td>Check for sameness of two strings using an algorithm with timing</td>
  <td>CPasswordHelper</td>
</tr>
<tr id="verifyPassword">
  <td><?php echo CHtml::link('verifyPassword()', array('/site/doc', 'view' => 'CPasswordHelper', '#' => 'verifyPassword-detail')); ?></td>
...
<tr id="checkBlowfish">
  <td><?php echo CHtml::link('checkBlowfish()', array('/site/doc', 'view' => 'CPasswordHelper', '#' => 'checkBlowfish-detail')); ?></td>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\utils\CPasswordHelper.php#L59">yii\utils\CPasswordHelper.php#L59</a> (<b><a href="#" class="show">show</a></b>)
...
<tr>
  <td class="paramNameCol">{return}</td>
  <td class="paramTypeCol">string</td>
  <td class="paramDescCol">The password hash string, ASCII and not longer than 64 characters.</td>
</tr>
</table>

<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\utils\CPasswordHelper.php#L90">yii\utils\CPasswordHelper.php#L90</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\utils\CPasswordHelper.php#L148">yii\utils\CPasswordHelper.php#L148</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<ul>
	...
	<li>https://github.com/ircmaxell/password_compat/blob/master/lib/password.php</li>
</ul>
</div>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\utils\CPasswordHelper.php#L110">yii\utils\CPasswordHelper.php#L110</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
