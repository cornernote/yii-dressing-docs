<?php
$this->pageTitle = $this->pageHeading = 'TbDetailView';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'TbDetailView';
?>
<div id="nav">
...
<tr>
  <th>Subclasses</th>
  <td><?php echo CHtml::link('TbEditableDetailView', array('/site/doc', 'view' => 'TbEditableDetailView')); ?>, <?php echo CHtml::link('YdDetailView', array('/site/doc', 'view' => 'YdDetailView')); ?></td>
</tr>
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbDetailView.php">booster\widgets\TbDetailView.php</a></td>
</tr>
</table>

<div id="classDescription">
## Bootstrap Zii detail view.</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'TbDetailView', '#' => 'actions')); ?>.</td>
...
<tr class="inherited" id="htmlOptions">
  ...
  <td>array</td>
  <td>the HTML options used for <?php echo CHtml::link('tagName', array('/site/doc', 'view' => 'TbDetailView', '#' => 'tagName')); ?></td>
  <td><?php echo CHtml::link('CDetailView', array('/site/doc', 'view' => 'CDetailView')); ?></td>
</tr>
...
<tr id="init">
  <td><?php echo CHtml::link('init()', array('/site/doc', 'view' => 'TbDetailView', '#' => 'init-detail')); ?></td>
  <td>### .init()</td>
  <td>TbDetailView</td>
</tr>
...
<tr class="inherited" id="renderItem">
...
<p>the URL of the CSS file used by this detail view.
...
<p>the table type.
Valid values are 'striped', 'bordered' and/or 'condensed'.</p>
