<?php
$this->pageTitle = $this->pageHeading = 'CSafeValidator';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CSafeValidator';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/validators/CSafeValidator.php">yii/validators/CSafeValidator.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
CSafeValidator marks the associated attributes to be safe for massive assignments.</div>
<a name="properties"></a>
...
<tr id="validateAttribute">
  <td><?php echo CHtml::link('validateAttribute()', array('/site/doc', 'view' => 'CSafeValidator', '#' => 'validateAttribute-detail')); ?></td>
  <td>Validates the attribute of the object.</td>
  <td>CSafeValidator</td>
</tr>
</table>
</div>
<a name="events"></a>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/validators/CSafeValidator.php#L26">yii/validators/CSafeValidator.php#L26</a> (<b><a href="#" class="show">show</a></b>)
