<?php
$this->pageTitle = $this->pageHeading = 'TbDateRangePicker';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'TbDateRangePicker';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class TbDateRangePicker &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbDateRangePicker.php">booster\widgets\TbDateRangePicker.php</a></td>
</tr>
</table>

<div id="classDescription">
## A simple implementation for date range picker for Twitter Bootstrap</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'TbDateRangePicker', '#' => 'actions')); ?>.</td>
...
<tr id="callback">
  <td><?php echo CHtml::link('callback', array('/site/doc', 'view' => 'TbDateRangePicker', '#' => 'callback-detail')); ?></td>
  <td>string</td>
  <td>JS Callback for Daterange picker</td>
  <td>TbDateRangePicker</td>
</tr>
...
<tr id="form">
  <td><?php echo CHtml::link('form', array('/site/doc', 'view' => 'TbDateRangePicker', '#' => 'form-detail')); ?></td>
  <td><?php echo CHtml::link('TbActiveForm', array('/site/doc', 'view' => 'TbActiveForm')); ?></td>
  <td>when created via TbActiveForm.</td>
  <td>TbDateRangePicker</td>
</tr>
<tr id="htmlOptions">
  <td><?php echo CHtml::link('htmlOptions', array('/site/doc', 'view' => 'TbDateRangePicker', '#' => 'htmlOptions-detail')); ?></td>
  <td>array</td>
...
<tr id="options">
  <td><?php echo CHtml::link('options', array('/site/doc', 'view' => 'TbDateRangePicker', '#' => 'options-detail')); ?></td>
  <td>array</td>
  <td>Options to be passed to daterange picker</td>
  <td>TbDateRangePicker</td>
</tr>
...
<tr id="selector">
  <td><?php echo CHtml::link('selector', array('/site/doc', 'view' => 'TbDateRangePicker', '#' => 'selector-detail')); ?></td>
  <td>string</td>
  <td>$selector</td>
  <td>TbDateRangePicker</td>
</tr>
...
<tr id="init">
  <td><?php echo CHtml::link('init()', array('/site/doc', 'view' => 'TbDateRangePicker', '#' => 'init-detail')); ?></td>
  <td>### .init()</td>
  <td>TbDateRangePicker</td>
</tr>
...
<tr id="registerClientScript">
  <td><?php echo CHtml::link('registerClientScript()', array('/site/doc', 'view' => 'TbDateRangePicker', '#' => 'registerClientScript-detail')); ?></td>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'TbDateRangePicker', '#' => 'run-detail')); ?></td>
  <td>### .run()</td>
  <td>TbDateRangePicker</td>
</tr>
...
<p>JS Callback for Daterange picker</p>
...
<p>Options to be passed to daterange picker</p>
...
<div class="signature">
public string <b>$selector</b>;</div>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbDateRangePicker.php#L51">booster\widgets\TbDateRangePicker.php#L51</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">init</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">registerClientScript</span><span style="color: #007700">();<br />}</span>
</span>
</code></div>
</div>
<p>### .init()
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbDateRangePicker.php#L127">booster\widgets\TbDateRangePicker.php#L127</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">registerClientScript</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">app</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">bootstrap</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">registerAssetCss</span><span style="color: #007700">(</span><span style="color: #DD0000">'bootstrap-daterangepicker.css'</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">app</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">bootstrap</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">registerAssetJs</span><span style="color: #007700">(</span><span style="color: #DD0000">'bootstrap.daterangepicker.js'</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">app</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">bootstrap</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">registerPackage</span><span style="color: #007700">(</span><span style="color: #DD0000">'moment'</span><span style="color: #007700">);<br />}</span>
</span>
</code></div>
</div>
<p>### .registerClientScript()
<br/><br/>
Registers required css js files</p>
