<?php
$this->pageTitle = $this->pageHeading = 'EmailSpoolCommand';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'EmailSpoolCommand';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class EmailSpoolCommand &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/master/src/master/src/commands/EmailSpoolCommand.php">dressing/commands/EmailSpoolCommand.php</a></td>
</tr>
<tr>
  <th>Authors</th>
...
<tr id="actionIndex">
  <td><?php echo CHtml::link('actionIndex()', array('/site/doc', 'view' => 'EmailSpoolCommand', '#' => 'actionIndex-detail')); ?></td>
  <td>SEND TO MAILINATOR.COM</td>
  <td>EmailSpoolCommand</td>
</tr>
<tr id="actionLive">
  <td><?php echo CHtml::link('actionLive()', array('/site/doc', 'view' => 'EmailSpoolCommand', '#' => 'actionLive-detail')); ?></td>
...
<tr id="instance">
  <td><?php echo CHtml::link('instance()', array('/site/doc', 'view' => 'EmailSpoolCommand', '#' => 'instance-detail')); ?></td>
  <td></td>
  <td>EmailSpoolCommand</td>
</tr>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/master/src/master/src/commands/EmailSpoolCommand.php#L41">dressing/commands/EmailSpoolCommand.php#L41</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">actionLive</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;long&nbsp;loop<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">set_time_limit</span><span style="color: #007700">(</span><span style="color: #0000BB">60&nbsp;</span><span style="color: #007700">*&nbsp;</span><span style="color: #0000BB">60&nbsp;</span><span style="color: #007700">*&nbsp;</span><span style="color: #0000BB">24</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;for&nbsp;(</span><span style="color: #0000BB">$i&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">0</span><span style="color: #007700">;&nbsp;</span><span style="color: #0000BB">$i&nbsp;</span><span style="color: #007700">&lt;&nbsp;</span><span style="color: #0000BB">60&nbsp;</span><span style="color: #007700">*&nbsp;</span><span style="color: #0000BB">60</span><span style="color: #007700">;&nbsp;</span><span style="color: #0000BB">$i</span><span style="color: #007700">++)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">EmailSpool</span><span style="color: #007700">::</span><span style="color: #0000BB">spool</span><span style="color: #007700">();<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">sleep</span><span style="color: #007700">(</span><span style="color: #0000BB">1</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />}</span>
</span>
</code></div>
</div>
...
<tr><td colspan="3">
<div class="signature2">
public static EmailSpoolCommand <b>instance</b>(string $class='EmailSpoolCommand')</div>
</td></tr>
<tr>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/master/src/master/src/commands/EmailSpoolCommand.php#L20">dressing/commands/EmailSpoolCommand.php#L20</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
