...
For available attributes and values read <?php echo CHtml::link('TbButton', array('/site/doc', 'view' => 'TbButton')); ?> documentation.</div>
<a name="properties"></a>
...
<tr id="name">
  <td><?php echo CHtml::link('name', array('/site/doc', 'view' => 'TbFormButtonElement', '#' => 'name-detail')); ?></td>
  <td>string</td>
  <td>Name of this button.</td>
  <td>TbFormButtonElement</td>
</tr>
<tr id="on">
  <td><?php echo CHtml::link('on', array('/site/doc', 'view' => 'TbFormButtonElement', '#' => 'on-detail')); ?></td>
  <td>string</td>
...
<tr id="getOn">
  <td><?php echo CHtml::link('getOn()', array('/site/doc', 'view' => 'TbFormButtonElement', '#' => 'getOn-detail')); ?></td>
  <td>Returns a value indicating under which scenarios this button is visible.</td>
  <td>TbFormButtonElement</td>
</tr>
...
<tr id="setOn">
  <td><?php echo CHtml::link('setOn()', array('/site/doc', 'view' => 'TbFormButtonElement', '#' => 'setOn-detail')); ?></td>
...
<tr id="evaluateVisible">
  <td><?php echo CHtml::link('evaluateVisible()', array('/site/doc', 'view' => 'TbFormButtonElement', '#' => 'evaluateVisible-detail')); ?></td>
...
<div class="signature">
public string <?php echo CHtml::link('<b>getOn</b>', array('/site/doc', 'view' => 'TbFormButtonElement', '#' => 'getOn')); ?>()<br/>public void <?php echo CHtml::link('<b>setOn</b>', array('/site/doc', 'view' => 'TbFormButtonElement', '#' => 'setOn')); ?>(string $value)</div>
...
This method will check the <?php echo CHtml::link('on', array('/site/doc', 'view' => 'TbFormButtonElement', '#' => 'on')); ?> property to see if
...
<tr>
  <td class="paramNameCol">{return}</td>
  <td class="paramTypeCol">string</td>
  <td class="paramDescCol">The rendered button.</td>
</tr>
</table>
