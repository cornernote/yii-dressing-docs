<?php
$this->pageTitle = $this->pageHeading = 'TbJsonGridColumn';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'TbJsonGridColumn';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class TbJsonGridColumn &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbJsonGridColumn.php">booster\widgets\TbJsonGridColumn.php</a></td>
</tr>
</table>
...
This is the base class for TbJsonDataColumn</div>
<a name="properties"></a>
...
<tr id="grid">
  <td><?php echo CHtml::link('grid', array('/site/doc', 'view' => 'TbJsonGridColumn', '#' => 'grid-detail')); ?></td>
  <td><?php echo CHtml::link('TbJsonGridView', array('/site/doc', 'view' => 'TbJsonGridView')); ?></td>
  <td></td>
  <td>TbJsonGridColumn</td>
</tr>
...
<tr class="inherited" id="value">
  ...
  <td>string</td>
  <td>a PHP expression that will be evaluated for every data cell using <?php echo CHtml::link('evaluateExpression', array('/site/doc', 'view' => 'TbJsonGridColumn', '#' => 'evaluateExpression')); ?> and whose result will be rendered
...
This is determined based on whether <?php echo CHtml::link('footer', array('/site/doc', 'view' => 'TbJsonGridColumn', '#' => 'footer')); ?> is set.</td>
  <td><?php echo CHtml::link('CGridColumn', array('/site/doc', 'view' => 'CGridColumn')); ?></td>
</tr>
