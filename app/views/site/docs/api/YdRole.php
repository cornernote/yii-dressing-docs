<?php
$this->pageTitle = $this->pageHeading = 'YdRole';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'YdRole';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.1.0/yii-dressing/models/YdRole.php">dressing/models/YdRole.php</a></td>
</tr>
<tr>
  <th>Authors</th>
...
<br/><br/>
This is the model class for table 'role'</div>
<a name="properties"></a>
...
<tr id="controllerName">
  <td><?php echo CHtml::link('controllerName', array('/site/doc', 'view' => 'YdRole', '#' => 'controllerName-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdRole</td>
</tr>
...
<tr id="id">
  <td><?php echo CHtml::link('id', array('/site/doc', 'view' => 'YdRole', '#' => 'id-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdRole</td>
</tr>
...
<tr class="inherited" id="validators">
  ...
  <td>array</td>
  <td>Returns the validators applicable to the current <?php echo CHtml::link('scenario', array('/site/doc', 'view' => 'YdRole', '#' => 'scenario')); ?>.</td>
  <td><?php echo CHtml::link('CModel', array('/site/doc', 'view' => 'CModel')); ?></td>
</tr>
</table>
</div>
...
<tr class="inherited" id="afterFindInternal">
  ...
  <td>Calls <?php echo CHtml::link('afterFind', array('/site/doc', 'view' => 'YdRole', '#' => 'afterFind')); ?>.</td>
  <td><?php echo CHtml::link('CActiveRecord', array('/site/doc', 'view' => 'CActiveRecord')); ?></td>
</tr>
...
<tr class="inherited" id="beforeFindInternal">
  ...
  <td>Calls <?php echo CHtml::link('beforeFind', array('/site/doc', 'view' => 'YdRole', '#' => 'beforeFind')); ?>.</td>
  <td><?php echo CHtml::link('CActiveRecord', array('/site/doc', 'view' => 'CActiveRecord')); ?></td>
</tr>
...
<tr class="inherited" id="createValidators">
  ...
  <td>Creates validator objects based on the specification in <?php echo CHtml::link('rules', array('/site/doc', 'view' => 'YdRole', '#' => 'rules')); ?>.</td>
  <td><?php echo CHtml::link('CModel', array('/site/doc', 'view' => 'CModel')); ?></td>
</tr>
...
<tr id="getControllerName">
  <td><?php echo CHtml::link('getControllerName()', array('/site/doc', 'view' => 'YdRole', '#' => 'getControllerName-detail')); ?></td>
  <td></td>
  <td>YdRole</td>
</tr>
...
<tr id="model">
  <td><?php echo CHtml::link('model()', array('/site/doc', 'view' => 'YdRole', '#' => 'model-detail')); ?></td>
...
<tr id="search">
  <td><?php echo CHtml::link('search()', array('/site/doc', 'view' => 'YdRole', '#' => 'search-detail')); ?></td>
...
<div class="signature">
public string <?php echo CHtml::link('<b>getControllerName</b>', array('/site/doc', 'view' => 'YdRole', '#' => 'getControllerName')); ?>()</div>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.1.0/yii-dressing/models/YdRole.php#L71">dressing/models/YdRole.php#L71</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">getControllerName</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #DD0000">'role'</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
<p></p>
...
<tr><td colspan="3">
<div class="signature2">
public static YdRole <b>model</b>(string $className='YdRole')</div>
</td></tr>
<tr>
...
<tr>
  <td class="paramNameCol">{return}</td>
  <td class="paramTypeCol">YdRole</td>
  <td class="paramDescCol">the static model class</td>
</tr>
</table>

<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.1.0/yii-dressing/models/YdRole.php#L47">dressing/models/YdRole.php#L47</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.1.0/yii-dressing/models/YdRole.php#L57">dressing/models/YdRole.php#L57</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
