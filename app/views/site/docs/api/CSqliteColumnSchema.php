<?php
$this->pageTitle = $this->pageHeading = 'CSqliteColumnSchema';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CSqliteColumnSchema';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CSqliteColumnSchema &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\db\schema\sqlite\CSqliteColumnSchema.php">yii\db\schema\sqlite\CSqliteColumnSchema.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
CSqliteColumnSchema class describes the column meta data of a SQLite table.</div>
<a name="properties"></a>
...
<tr id="extractDefault">
  <td><?php echo CHtml::link('extractDefault()', array('/site/doc', 'view' => 'CSqliteColumnSchema', '#' => 'extractDefault-detail')); ?></td>
  <td>Extracts the default value for the column.</td>
  <td>CSqliteColumnSchema</td>
</tr>
...
<tr class="inherited" id="extractType">
