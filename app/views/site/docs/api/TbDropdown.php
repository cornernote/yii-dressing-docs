<?php
$this->pageTitle = $this->pageHeading = 'TbDropdown';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'TbDropdown';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbDropdown.php">booster\widgets\TbDropdown.php</a></td>
</tr>
</table>

<div id="classDescription">
## Bootstrap dropdown menu.</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'TbDropdown', '#' => 'actions')); ?>.</td>
...
<tr id="dividerCssClass">
  <td><?php echo CHtml::link('dividerCssClass', array('/site/doc', 'view' => 'TbDropdown', '#' => 'dividerCssClass-detail')); ?></td>
  <td>string</td>
  <td>### .getDividerCssClass()</td>
  <td>TbDropdown</td>
</tr>
<tr id="dropdownCssClass">
  <td><?php echo CHtml::link('dropdownCssClass', array('/site/doc', 'view' => 'TbDropdown', '#' => 'dropdownCssClass-detail')); ?></td>
  <td>string</td>
...
<?php echo CHtml::link('linkLabelWrapper', array('/site/doc', 'view' => 'TbDropdown', '#' => 'linkLabelWrapper')); ?>.</td>
  <td><?php echo CHtml::link('CMenu', array('/site/doc', 'view' => 'CMenu')); ?></td>
</tr>
...
<tr id="getDividerCssClass">
  <td><?php echo CHtml::link('getDividerCssClass()', array('/site/doc', 'view' => 'TbDropdown', '#' => 'getDividerCssClass-detail')); ?></td>
  <td>### .getDividerCssClass()</td>
  <td>TbDropdown</td>
</tr>
<tr id="getDropdownCssClass">
  <td><?php echo CHtml::link('getDropdownCssClass()', array('/site/doc', 'view' => 'TbDropdown', '#' => 'getDropdownCssClass-detail')); ?></td>
  <td>### .getDropdownCssClass()</td>
  <td>TbDropdown</td>
</tr>
...
<tr id="init">
  <td><?php echo CHtml::link('init()', array('/site/doc', 'view' => 'TbDropdown', '#' => 'init-detail')); ?></td>
  <td>### .init()</td>
  <td>TbDropdown</td>
</tr>
<tr id="isVertical">
  <td><?php echo CHtml::link('isVertical()', array('/site/doc', 'view' => 'TbDropdown', '#' => 'isVertical-detail')); ?></td>
  <td>### .isVertical()</td>
  <td>TbDropdown</td>
</tr>
...
<tr class="inherited" id="run">
  ...
  <td>Calls <?php echo CHtml::link('renderMenu', array('/site/doc', 'view' => 'TbDropdown', '#' => 'renderMenu')); ?> to render the menu.</td>
  <td><?php echo CHtml::link('CMenu', array('/site/doc', 'view' => 'CMenu')); ?></td>
</tr>
...
<tr id="renderMenuItem">
  <td><?php echo CHtml::link('renderMenuItem()', array('/site/doc', 'view' => 'TbDropdown', '#' => 'renderMenuItem-detail')); ?></td>
...
<div class="signature">
public string <?php echo CHtml::link('<b>getDividerCssClass</b>', array('/site/doc', 'view' => 'TbDropdown', '#' => 'getDividerCssClass')); ?>()</div>
...
<div class="signature">
public string <?php echo CHtml::link('<b>getDropdownCssClass</b>', array('/site/doc', 'view' => 'TbDropdown', '#' => 'getDropdownCssClass')); ?>()</div>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbDropdown.php#L82">booster\widgets\TbDropdown.php#L82</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">getDividerCssClass</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #DD0000">'divider'</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
<p>### .getDividerCssClass()
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbDropdown.php#L93">booster\widgets\TbDropdown.php#L93</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">getDropdownCssClass</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #DD0000">'dropdown-submenu'</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
<p>### .getDropdownCssClass()
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbDropdown.php#L27">booster\widgets\TbDropdown.php#L27</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">init</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">parent</span><span style="color: #007700">::</span><span style="color: #0000BB">init</span><span style="color: #007700">();<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(isset(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">htmlOptions</span><span style="color: #007700">[</span><span style="color: #DD0000">'class'</span><span style="color: #007700">]))&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">htmlOptions</span><span style="color: #007700">[</span><span style="color: #DD0000">'class'</span><span style="color: #007700">]&nbsp;.=&nbsp;</span><span style="color: #DD0000">'&nbsp;dropdown-menu'</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;}&nbsp;else&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">htmlOptions</span><span style="color: #007700">[</span><span style="color: #DD0000">'class'</span><span style="color: #007700">]&nbsp;=&nbsp;</span><span style="color: #DD0000">'dropdown-menu'</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />}</span>
</span>
</code></div>
</div>
<p>### .init()
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbDropdown.php#L104">booster\widgets\TbDropdown.php#L104</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">isVertical</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">true</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
<p>### .isVertical()
...
<tr>
  ...
  <td class="paramDescCol">the menu item to be rendered. Please see <?php echo CHtml::link('items', array('/site/doc', 'view' => 'TbDropdown', '#' => 'items')); ?> on what data might be in the item.</td>
</tr>
<tr>
  <td class="paramNameCol">{return}</td>
  <td class="paramTypeCol">string</td>
