<?php
$this->pageTitle = $this->pageHeading = 'CJuiDialog';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CJuiDialog';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\zii\widgets\jui\CJuiDialog.php">yii\zii\widgets\jui\CJuiDialog.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
<br/><br/>
CJuiDialog encapsulates the <a href="http://jqueryui.com/dialog/">JUI Dialog</a>
plugin.
<br/><br/>
...
<br/><br/>
By configuring the <?php echo CHtml::link('options', array('/site/doc', 'view' => 'CJuiDialog', '#' => 'options')); ?> property, you may specify the options
that need to be passed to the JUI dialog plugin. Please refer to
the <a href="http://api.jqueryui.com/dialog/">JUI Dialog API</a> documentation
for possible options (name-value pairs) and
<a href="http://jqueryui.com/dialog/">JUI Dialog page</a> for general description
and demo.</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'CJuiDialog', '#' => 'actions')); ?>.</td>
...
<tr id="tagName">
  <td><?php echo CHtml::link('tagName', array('/site/doc', 'view' => 'CJuiDialog', '#' => 'tagName-detail')); ?></td>
  <td>string</td>
...
<tr id="init">
  <td><?php echo CHtml::link('init()', array('/site/doc', 'view' => 'CJuiDialog', '#' => 'init-detail')); ?></td>
  <td>Renders the open tag of the dialog.</td>
  <td>CJuiDialog</td>
</tr>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'CJuiDialog', '#' => 'run-detail')); ?></td>
  <td>Renders the close tag of the dialog.</td>
  <td>CJuiDialog</td>
</tr>
...
<tr class="inherited" id="registerScriptFile">
  ...
  <td>Registers a JavaScript file under <?php echo CHtml::link('scriptUrl', array('/site/doc', 'view' => 'CJuiDialog', '#' => 'scriptUrl')); ?>.</td>
  <td><?php echo CHtml::link('CJuiWidget', array('/site/doc', 'view' => 'CJuiWidget')); ?></td>
</tr>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\zii\widgets\jui\CJuiDialog.php#L81">yii\zii\widgets\jui\CJuiDialog.php#L81</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<p>Renders the close tag of the dialog.</p>
