<?php
$this->pageTitle = $this->pageHeading = 'CMysqlCommandBuilder';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CMysqlCommandBuilder';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CMysqlCommandBuilder &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework\db\schema\mysql\CMysqlCommandBuilder.php">yii\db\schema\mysql\CMysqlCommandBuilder.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
CMysqlCommandBuilder provides basic methods to create query commands for tables.</div>
<a name="properties"></a>
...
<tr id="applyJoin">
  <td><?php echo CHtml::link('applyJoin()', array('/site/doc', 'view' => 'CMysqlCommandBuilder', '#' => 'applyJoin-detail')); ?></td>
  <td>Alters the SQL to apply JOIN clause.</td>
  <td>CMysqlCommandBuilder</td>
</tr>
