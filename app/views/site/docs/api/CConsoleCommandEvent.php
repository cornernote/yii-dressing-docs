<?php
$this->pageTitle = $this->pageHeading = 'CConsoleCommandEvent';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CConsoleCommandEvent';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CConsoleCommandEvent &raquo;
...
<br/><br/>
CConsoleCommandEvent represents the event parameters needed by events raised by a console command.</div>
<a name="properties"></a>
...
<tr id="action">
  <td><?php echo CHtml::link('action', array('/site/doc', 'view' => 'CConsoleCommandEvent', '#' => 'action-detail')); ?></td>
  <td>string</td>
  <td>the action name</td>
  <td>CConsoleCommandEvent</td>
</tr>
<tr id="exitCode">
  <td><?php echo CHtml::link('exitCode', array('/site/doc', 'view' => 'CConsoleCommandEvent', '#' => 'exitCode-detail')); ?></td>
  <td>integer</td>
  <td>exit code of application.</td>
  <td>CConsoleCommandEvent</td>
</tr>
...
<tr id="stopCommand">
  <td><?php echo CHtml::link('stopCommand', array('/site/doc', 'view' => 'CConsoleCommandEvent', '#' => 'stopCommand-detail')); ?></td>
  <td>boolean</td>
  <td>whether the action should be executed.</td>
  <td>CConsoleCommandEvent</td>
</tr>
</table>
</div>
...
<tr id="__construct">
  <td><?php echo CHtml::link('__construct()', array('/site/doc', 'view' => 'CConsoleCommandEvent', '#' => '__construct-detail')); ?></td>
  <td>Constructor.</td>
  <td>CConsoleCommandEvent</td>
</tr>
...
<div class="detailHeader" id="exitCode-detail">
exitCode<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public integer <b>$exitCode</b>;</div>

<p>exit code of application.
This property is available in <?php echo CHtml::link('CConsoleCommand::onAfterAction', array('/site/doc', 'view' => 'CConsoleCommand', '#' => 'onAfterAction')); ?> event and will be set to the exit code
returned by the console command action. You can set it to change application exit code.</p>


<div class="detailHeader" id="stopCommand-detail">
stopCommand<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public boolean <b>$stopCommand</b>;</div>

<p>whether the action should be executed.
...
<?php echo CHtml::link('CConsoleCommand::afterAction', array('/site/doc', 'view' => 'CConsoleCommand', '#' => 'afterAction')); ?>.</p>
...
public void <b>__construct</b>(mixed $sender=NULL, string $params=NULL, string $action=NULL, integer $exitCode=0)</div>
</td></tr>
<tr>
...
<tr>
  ...
  <td class="paramDescCol">the application exit code</td>
</tr>
</table>
