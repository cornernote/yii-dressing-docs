<?php
$this->pageTitle = $this->pageHeading = 'TbPassfield';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'TbPassfield';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src/widgets/TbPassfield.php">booster/widgets/TbPassfield.php</a></td>
</tr>
</table>

<div id="classDescription">
Bootstrap Pass*Field widget</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'TbPassfield', '#' => 'actions')); ?>.</td>
...
<tr id="events">
  <td><?php echo CHtml::link('events', array('/site/doc', 'view' => 'TbPassfield', '#' => 'events-detail')); ?></td>
  <td>string[]</td>
  <td>the JavaScript event handlers.</td>
  <td>TbPassfield</td>
</tr>
<tr id="form">
  <td><?php echo CHtml::link('form', array('/site/doc', 'view' => 'TbPassfield', '#' => 'form-detail')); ?></td>
...
<tr id="options">
  <td><?php echo CHtml::link('options', array('/site/doc', 'view' => 'TbPassfield', '#' => 'options-detail')); ?></td>
  <td>array</td>
...
<tr id="init">
  <td><?php echo CHtml::link('init()', array('/site/doc', 'view' => 'TbPassfield', '#' => 'init-detail')); ?></td>
  <td>### .init()</td>
  <td>TbPassfield</td>
</tr>
...
<tr id="registerClientScript">
  <td><?php echo CHtml::link('registerClientScript()', array('/site/doc', 'view' => 'TbPassfield', '#' => 'registerClientScript-detail')); ?></td>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'TbPassfield', '#' => 'run-detail')); ?></td>
  <td>### .run()</td>
  <td>TbPassfield</td>
</tr>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src/widgets/TbPassfield.php#L92">booster/widgets/TbPassfield.php#L92</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">registerClientScript</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">app</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">bootstrap</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">registerPackage</span><span style="color: #007700">(</span><span style="color: #DD0000">'passfield'</span><span style="color: #007700">);<br />}</span>
</span>
</code></div>
</div>
