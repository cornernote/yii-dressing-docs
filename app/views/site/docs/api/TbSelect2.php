<?php
$this->pageTitle = $this->pageHeading = 'TbSelect2';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'TbSelect2';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbSelect2.php">booster\widgets\TbSelect2.php</a></td>
</tr>
</table>

<div id="classDescription">
## Select2 wrapper widget</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'TbSelect2', '#' => 'actions')); ?>.</td>
  <td><?php echo CHtml::link('CWidget', array('/site/doc', 'view' => 'CWidget')); ?></td>
</tr>
<tr id="asDropDownList">
  <td><?php echo CHtml::link('asDropDownList', array('/site/doc', 'view' => 'TbSelect2', '#' => 'asDropDownList-detail')); ?></td>
  <td>bool</td>
  <td>whether to display a dropdown select box or use it for tagging</td>
  <td>TbSelect2</td>
</tr>
...
<tr id="data">
  <td><?php echo CHtml::link('data', array('/site/doc', 'view' => 'TbSelect2', '#' => 'data-detail')); ?></td>
  <td>array</td>
  <td>@param data for generating the list options (value=>display)</td>
  <td>TbSelect2</td>
</tr>
<tr id="events">
  <td><?php echo CHtml::link('events', array('/site/doc', 'view' => 'TbSelect2', '#' => 'events-detail')); ?></td>
  <td>string[]</td>
  <td>the JavaScript event handlers.</td>
  <td>TbSelect2</td>
</tr>
<tr id="form">
  <td><?php echo CHtml::link('form', array('/site/doc', 'view' => 'TbSelect2', '#' => 'form-detail')); ?></td>
...
<tr id="options">
  <td><?php echo CHtml::link('options', array('/site/doc', 'view' => 'TbSelect2', '#' => 'options-detail')); ?></td>
  <td></td>
  <td></td>
  <td>TbSelect2</td>
</tr>
...
<tr id="val">
  <td><?php echo CHtml::link('val', array('/site/doc', 'view' => 'TbSelect2', '#' => 'val-detail')); ?></td>
  <td>string</td>
...
<tr id="init">
  <td><?php echo CHtml::link('init()', array('/site/doc', 'view' => 'TbSelect2', '#' => 'init-detail')); ?></td>
  <td>### .init()</td>
  <td>TbSelect2</td>
</tr>
...
<tr id="registerClientScript">
  <td><?php echo CHtml::link('registerClientScript()', array('/site/doc', 'view' => 'TbSelect2', '#' => 'registerClientScript-detail')); ?></td>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'TbSelect2', '#' => 'run-detail')); ?></td>
  <td>### .run()</td>
  <td>TbSelect2</td>
</tr>
...
<div class="detailHeader" id="asDropDownList-detail">
asDropDownList<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public bool <b>$asDropDownList</b>;</div>

<p>whether to display a dropdown select box or use it for tagging</p>
...
<p>@param data for generating the list options (value=>display)</p>
...
<div class="signature">
public  <b>$options</b>;</div>

<p></p>


<div class="detailHeader" id="val-detail">
val<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public string <b>$val</b>;</div>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbSelect2.php#L55">booster\widgets\TbSelect2.php#L55</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">init</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">normalizeData</span><span style="color: #007700">();<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">normalizeOptions</span><span style="color: #007700">();<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addEmptyItemIfPlaceholderDefined</span><span style="color: #007700">();<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setDefaultWidthIfEmpty</span><span style="color: #007700">();<br />}</span>
</span>
</code></div>
</div>
<p>### .init()
...
<tr><td colspan="3">
<div class="signature2">
public void <b>registerClientScript</b>($id)</div>
</td></tr>
<tr>
