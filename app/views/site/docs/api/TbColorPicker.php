<?php
$this->pageTitle = $this->pageHeading = 'TbColorPicker';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'TbColorPicker';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbColorPicker.php">booster\widgets\TbColorPicker.php</a></td>
</tr>
</table>
...
------------------------------------------------------------------------
  ...
  and the rest usage you'd better refer the original plugin</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'TbColorPicker', '#' => 'actions')); ?>.</td>
...
<tr id="events">
  <td><?php echo CHtml::link('events', array('/site/doc', 'view' => 'TbColorPicker', '#' => 'events-detail')); ?></td>
  <td>string[]</td>
  <td>the JavaScript event handlers.</td>
  <td>TbColorPicker</td>
</tr>
<tr id="form">
  <td><?php echo CHtml::link('form', array('/site/doc', 'view' => 'TbColorPicker', '#' => 'form-detail')); ?></td>
  <td><?php echo CHtml::link('TbActiveForm', array('/site/doc', 'view' => 'TbActiveForm')); ?></td>
  <td>when created via TbActiveForm.</td>
  <td>TbColorPicker</td>
</tr>
<tr id="format">
  <td><?php echo CHtml::link('format', array('/site/doc', 'view' => 'TbColorPicker', '#' => 'format-detail')); ?></td>
  <td>string</td>
...
<tr id="registerClientScript">
  <td><?php echo CHtml::link('registerClientScript()', array('/site/doc', 'view' => 'TbColorPicker', '#' => 'registerClientScript-detail')); ?></td>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'TbColorPicker', '#' => 'run-detail')); ?></td>
  <td>### .run()</td>
  <td>TbColorPicker</td>
</tr>
...
<p>the color format - hex | rgb | rgba. Defaults to 'hex'</p>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src\widgets\TbColorPicker.php#L62">booster\widgets\TbColorPicker.php#L62</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
