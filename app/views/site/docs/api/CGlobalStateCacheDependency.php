<?php
$this->pageTitle = $this->pageHeading = 'CGlobalStateCacheDependency';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CGlobalStateCacheDependency';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CGlobalStateCacheDependency &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\caching\dependencies\CGlobalStateCacheDependency.php">yii\caching\dependencies\CGlobalStateCacheDependency.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
set <?php echo CHtml::link('stateName', array('/site/doc', 'view' => 'CGlobalStateCacheDependency', '#' => 'stateName')); ?> to the name of the global state.</div>
<a name="properties"></a>
...
<tr id="stateName">
  <td><?php echo CHtml::link('stateName', array('/site/doc', 'view' => 'CGlobalStateCacheDependency', '#' => 'stateName-detail')); ?></td>
  <td>string</td>
  <td>the name of the global state whose value is to check
if the dependency has changed.</td>
  <td>CGlobalStateCacheDependency</td>
</tr>
</table>
</div>
<a name="methods"></a>
...
<tr id="__construct">
  <td><?php echo CHtml::link('__construct()', array('/site/doc', 'view' => 'CGlobalStateCacheDependency', '#' => '__construct-detail')); ?></td>
  <td>Constructor.</td>
  <td>CGlobalStateCacheDependency</td>
</tr>
...
This data is available after <?php echo CHtml::link('evaluateDependency', array('/site/doc', 'view' => 'CGlobalStateCacheDependency', '#' => 'evaluateDependency')); ?> is called.</td>
  <td><?php echo CHtml::link('CCacheDependency', array('/site/doc', 'view' => 'CCacheDependency')); ?></td>
</tr>
...
<tr id="generateDependentData">
  <td><?php echo CHtml::link('generateDependentData()', array('/site/doc', 'view' => 'CGlobalStateCacheDependency', '#' => 'generateDependentData-detail')); ?></td>
...
<div class="detailHeader" id="stateName-detail">
stateName<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public string <b>$stateName</b>;</div>

<p>the name of the global state whose value is to check
if the dependency has changed.</p>

<div class="SeeAlso">
<h4>See Also</h4>
<ul>
	<li><?php echo CHtml::link('CApplication::setGlobalState', array('/site/doc', 'view' => 'CApplication', '#' => 'setGlobalState')); ?></li>
</ul>
</div>
...
public void <b>__construct</b>(string $name=NULL)</div>
</td></tr>
<tr>
  <td class="paramNameCol">$name</td>
  <td class="paramTypeCol">string</td>
  <td class="paramDescCol">the name of the global state</td>
</tr>
</table>

<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\caching\dependencies\CGlobalStateCacheDependency.php#L36">yii\caching\dependencies\CGlobalStateCacheDependency.php#L36</a> (<b><a href="#" class="show">show</a></b>)
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/\caching\dependencies\CGlobalStateCacheDependency.php#L47">yii\caching\dependencies\CGlobalStateCacheDependency.php#L47</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">protected&nbsp;function&nbsp;</span><span style="color: #0000BB">generateDependentData</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;if(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">stateName</span><span style="color: #007700">!==</span><span style="color: #0000BB">null</span><span style="color: #007700">)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">app</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">getGlobalState</span><span style="color: #007700">(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">stateName</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;else<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw&nbsp;new&nbsp;</span><span style="color: #0000BB">CException</span><span style="color: #007700">(</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">t</span><span style="color: #007700">(</span><span style="color: #DD0000">'yii'</span><span style="color: #007700">,</span><span style="color: #DD0000">'CGlobalStateCacheDependency.stateName&nbsp;cannot&nbsp;be&nbsp;empty.'</span><span style="color: #007700">));<br />}</span>
</span>
</code></div>
</div>
