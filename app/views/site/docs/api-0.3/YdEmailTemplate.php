...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/models/YdEmailTemplate.php">dressing/models/YdEmailTemplate.php</a></td>
</tr>
<tr>
  <th>Authors</th>
...
<tr id="created">
  <td><?php echo CHtml::link('created', array('/site/doc', 'view' => 'YdEmailTemplate', '#' => 'created-detail')); ?></td>
  <td>datetime</td>
  <td></td>
  <td>YdEmailTemplate</td>
</tr>
...
<tr id="deleted">
  <td><?php echo CHtml::link('deleted', array('/site/doc', 'view' => 'YdEmailTemplate', '#' => 'deleted-detail')); ?></td>
  <td>datetime</td>
  <td></td>
  <td>YdEmailTemplate</td>
</tr>
<tr id="description">
  <td><?php echo CHtml::link('description', array('/site/doc', 'view' => 'YdEmailTemplate', '#' => 'description-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdEmailTemplate</td>
</tr>
...
<tr id="id">
  <td><?php echo CHtml::link('id', array('/site/doc', 'view' => 'YdEmailTemplate', '#' => 'id-detail')); ?></td>
  <td>integer</td>
  <td></td>
  <td>YdEmailTemplate</td>
</tr>
...
<tr id="message_html">
  <td><?php echo CHtml::link('message_html', array('/site/doc', 'view' => 'YdEmailTemplate', '#' => 'message_html-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdEmailTemplate</td>
</tr>
<tr id="message_subject">
  <td><?php echo CHtml::link('message_subject', array('/site/doc', 'view' => 'YdEmailTemplate', '#' => 'message_subject-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdEmailTemplate</td>
</tr>
<tr id="message_text">
  <td><?php echo CHtml::link('message_text', array('/site/doc', 'view' => 'YdEmailTemplate', '#' => 'message_text-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdEmailTemplate</td>
</tr>
...
<tr id="name">
  <td><?php echo CHtml::link('name', array('/site/doc', 'view' => 'YdEmailTemplate', '#' => 'name-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdEmailTemplate</td>
</tr>
...
<div class="detailHeader" id="description-detail">
description<span class="detailHeaderTag">
property
</span>
</div>
...
<div class="detailHeader" id="name-detail">
name<span class="detailHeaderTag">
property
</span>
</div>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/models/YdEmailTemplate.php#L124">dressing/models/YdEmailTemplate.php#L124</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">getControllerName</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #DD0000">'emailTemplate'</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
<p></p>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/models/YdEmailTemplate.php#L50">dressing/models/YdEmailTemplate.php#L50</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/models/YdEmailTemplate.php#L108">dressing/models/YdEmailTemplate.php#L108</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
