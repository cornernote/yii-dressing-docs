<?php
$this->pageTitle = $this->pageHeading = 'YdDetailView';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'YdDetailView';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/widgets/YdDetailView.php">dressing/widgets/YdDetailView.php</a></td>
</tr>
<tr>
  <th>Authors</th>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'YdDetailView', '#' => 'actions')); ?>.</td>
...
<tr class="inherited" id="htmlOptions">
  ...
  <td>array</td>
  <td>the HTML options used for <?php echo CHtml::link('tagName', array('/site/doc', 'view' => 'YdDetailView', '#' => 'tagName')); ?></td>
  <td><?php echo CHtml::link('CDetailView', array('/site/doc', 'view' => 'CDetailView')); ?></td>
</tr>
...
<tr id="type">
  <td><?php echo CHtml::link('type', array('/site/doc', 'view' => 'YdDetailView', '#' => 'type-detail')); ?></td>
  <td>array</td>
  <td></td>
  <td>YdDetailView</td>
</tr>
