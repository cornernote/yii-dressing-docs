<?php
$this->pageTitle = $this->pageHeading = 'CPgsqlTableSchema';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CPgsqlTableSchema';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CPgsqlTableSchema &raquo;
...
CPgsqlTable represents the metadata for a PostgreSQL table.</div>
<a name="properties"></a>
...
<tr id="schemaName">
  <td><?php echo CHtml::link('schemaName', array('/site/doc', 'view' => 'CPgsqlTableSchema', '#' => 'schemaName-detail')); ?></td>
  <td>string</td>
  <td>name of the schema that this table belongs to.</td>
  <td>CPgsqlTableSchema</td>
</tr>
...
<p>name of the schema that this table belongs to.</p>
