<?php
$this->pageTitle = $this->pageHeading = 'CJuiSelectable';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CJuiSelectable';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/zii/widgets/jui/CJuiSelectable.php">yii/zii/widgets/jui/CJuiSelectable.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
<br/><br/>
CJuiSelectable encapsulates the <a href="http://jqueryui.com/selectable/">JUI Selectable</a>
plugin.
<br/><br/>
...
<br/><br/>
By configuring the <?php echo CHtml::link('options', array('/site/doc', 'view' => 'CJuiSelectable', '#' => 'options')); ?> property, you may specify the options
that need to be passed to the JUI Selectable plugin. Please refer to
the <a href="http://api.jqueryui.com/selectable/">JUI Selectable API</a>
documentation for possible options (name-value pairs) and
<a href="http://jqueryui.com/selectable/">JUI Selectable page</a> for general
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'CJuiSelectable', '#' => 'actions')); ?>.</td>
...
<tr id="itemTemplate">
  <td><?php echo CHtml::link('itemTemplate', array('/site/doc', 'view' => 'CJuiSelectable', '#' => 'itemTemplate-detail')); ?></td>
  <td>string</td>
  <td>the template that is used to generated every selectable item.</td>
  <td>CJuiSelectable</td>
</tr>
<tr id="items">
  <td><?php echo CHtml::link('items', array('/site/doc', 'view' => 'CJuiSelectable', '#' => 'items-detail')); ?></td>
  <td>array</td>
  <td>list of selectable items (id=>item content).</td>
  <td>CJuiSelectable</td>
</tr>
...
<tr id="tagName">
  <td><?php echo CHtml::link('tagName', array('/site/doc', 'view' => 'CJuiSelectable', '#' => 'tagName-detail')); ?></td>
  <td>string</td>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'CJuiSelectable', '#' => 'run-detail')); ?></td>
...
<tr class="inherited" id="registerScriptFile">
  ...
  <td>Registers a JavaScript file under <?php echo CHtml::link('scriptUrl', array('/site/doc', 'view' => 'CJuiSelectable', '#' => 'scriptUrl')); ?>.</td>
  <td><?php echo CHtml::link('CJuiWidget', array('/site/doc', 'view' => 'CJuiWidget')); ?></td>
</tr>
...
<p>the template that is used to generated every selectable item.
The token "{content}" in the template will be replaced with the item content,
while "{id}" will be replaced with the item ID.</p>
...
<p>list of selectable items (id=>item content).
...
<p>the name of the container element that contains all items. Defaults to 'ol'.</p>
