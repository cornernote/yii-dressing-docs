<?php
$this->pageTitle = $this->pageHeading = 'CInputWidget';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CInputWidget';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>abstract class CInputWidget &raquo;
...
<tr>
  <th>Subclasses</th>
  <td><?php echo CHtml::link('CAutoComplete', array('/site/doc', 'view' => 'CAutoComplete')); ?>, <?php echo CHtml::link('CMaskedTextField', array('/site/doc', 'view' => 'CMaskedTextField')); ?>, <?php echo CHtml::link('CMultiFileUpload', array('/site/doc', 'view' => 'CMultiFileUpload')); ?>, <?php echo CHtml::link('CStarRating', array('/site/doc', 'view' => 'CStarRating')); ?>, <?php echo CHtml::link('TbCKEditor', array('/site/doc', 'view' => 'TbCKEditor')); ?>, <?php echo CHtml::link('TbColorPicker', array('/site/doc', 'view' => 'TbColorPicker')); ?>, <?php echo CHtml::link('TbDatePicker', array('/site/doc', 'view' => 'TbDatePicker')); ?>, <?php echo CHtml::link('TbDateRangePicker', array('/site/doc', 'view' => 'TbDateRangePicker')); ?>, <?php echo CHtml::link('TbDateTimePicker', array('/site/doc', 'view' => 'TbDateTimePicker')); ?>, <?php echo CHtml::link('TbHtml5Editor', array('/site/doc', 'view' => 'TbHtml5Editor')); ?>, <?php echo CHtml::link('TbInput', array('/site/doc', 'view' => 'TbInput')); ?>, <?php echo CHtml::link('TbMarkdownEditorJS', array('/site/doc', 'view' => 'TbMarkdownEditorJS')); ?>, <?php echo CHtml::link('TbPassfield', array('/site/doc', 'view' => 'TbPassfield')); ?>, <?php echo CHtml::link('TbRedactorJS', array('/site/doc', 'view' => 'TbRedactorJS')); ?>, <?php echo CHtml::link('TbSelect2', array('/site/doc', 'view' => 'TbSelect2')); ?>, <?php echo CHtml::link('TbTags', array('/site/doc', 'view' => 'TbTags')); ?>, <?php echo CHtml::link('TbTimePicker', array('/site/doc', 'view' => 'TbTimePicker')); ?>, <?php echo CHtml::link('TbToggleButton', array('/site/doc', 'view' => 'TbToggleButton')); ?>, <?php echo CHtml::link('TbTypeahead', array('/site/doc', 'view' => 'TbTypeahead')); ?>, <?php echo CHtml::link('YdCKFinder', array('/site/doc', 'view' => 'YdCKFinder')); ?>, <?php echo CHtml::link('YdReCaptchaInput', array('/site/doc', 'view' => 'YdReCaptchaInput')); ?>, <?php echo CHtml::link('YdSimpleTreeWidget', array('/site/doc', 'view' => 'YdSimpleTreeWidget')); ?></td>
</tr>
<tr>
  <th>Since</th>
  <td>1.0</td>
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/web/widgets/CInputWidget.php">yii/web/widgets/CInputWidget.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
Child classes may use <?php echo CHtml::link('resolveNameID', array('/site/doc', 'view' => 'CInputWidget', '#' => 'resolveNameID')); ?> and <?php echo CHtml::link('hasModel', array('/site/doc', 'view' => 'CInputWidget', '#' => 'hasModel')); ?>.</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'CInputWidget', '#' => 'actions')); ?>.</td>
...
<p>additional HTML options to be rendered in the input tag</p>
...
<p>the input name. This must be set if <?php echo CHtml::link('model', array('/site/doc', 'view' => 'CInputWidget', '#' => 'model')); ?> is not set.</p>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/web/widgets/CInputWidget.php#L77">yii/web/widgets/CInputWidget.php#L77</a> (<b><a href="#" class="show">show</a></b>)
