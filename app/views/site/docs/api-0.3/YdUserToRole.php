...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/models/YdUserToRole.php">dressing/models/YdUserToRole.php</a></td>
</tr>
<tr>
  <th>Authors</th>
...
<tr id="id">
  <td><?php echo CHtml::link('id', array('/site/doc', 'view' => 'YdUserToRole', '#' => 'id-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdUserToRole</td>
</tr>
...
<tr id="role_id">
  <td><?php echo CHtml::link('role_id', array('/site/doc', 'view' => 'YdUserToRole', '#' => 'role_id-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdUserToRole</td>
</tr>
...
<tr id="user_id">
  <td><?php echo CHtml::link('user_id', array('/site/doc', 'view' => 'YdUserToRole', '#' => 'user_id-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdUserToRole</td>
</tr>
...
<div class="detailHeader" id="role_id-detail">
role_id<span class="detailHeaderTag">
property
</span>
</div>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/models/YdUserToRole.php#L43">dressing/models/YdUserToRole.php#L43</a> (<b><a href="#" class="show">show</a></b>)
