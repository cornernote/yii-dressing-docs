...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/behaviors/YdAuditBehavior.php">dressing/behaviors/YdAuditBehavior.php</a></td>
</tr>
<tr>
  <th>Authors</th>
  <td>MadSkillsTisdale, Brett O&#039;Donnell &lt;cornernote@gmail.com&gt;, Zain Ul abidin &lt;zainengineer@gmail.com&gt;</td>
</tr>
</table>
...
<tr id="enableAuditTrail">
  <td><?php echo CHtml::link('enableAuditTrail', array('/site/doc', 'view' => 'YdAuditBehavior', '#' => 'enableAuditTrail-detail')); ?></td>
  <td>bool</td>
  <td>Set to false if you just want to use getDbAttribute and other methods in this class.</td>
  <td>YdAuditBehavior</td>
</tr>
...
<tr id="__construct">
  <td><?php echo CHtml::link('__construct()', array('/site/doc', 'view' => 'YdAuditBehavior', '#' => '__construct-detail')); ?></td>
  <td></td>
  <td>YdAuditBehavior</td>
</tr>
...
<tr id="afterFind">
  <td><?php echo CHtml::link('afterFind()', array('/site/doc', 'view' => 'YdAuditBehavior', '#' => 'afterFind-detail')); ?></td>
...
<tr id="changed">
  <td><?php echo CHtml::link('changed()', array('/site/doc', 'view' => 'YdAuditBehavior', '#' => 'changed-detail')); ?></td>
...
<tr id="getDbAttribute">
  <td><?php echo CHtml::link('getDbAttribute()', array('/site/doc', 'view' => 'YdAuditBehavior', '#' => 'getDbAttribute-detail')); ?></td>
...
<tr id="getFieldPrefix">
  <td><?php echo CHtml::link('getFieldPrefix()', array('/site/doc', 'view' => 'YdAuditBehavior', '#' => 'getFieldPrefix-detail')); ?></td>
  <td>If the model is not the same as the owner then prefix the field so we know the model.</td>
  <td>YdAuditBehavior</td>
</tr>
<tr id="getPrimaryKeyString">
  <td><?php echo CHtml::link('getPrimaryKeyString()', array('/site/doc', 'view' => 'YdAuditBehavior', '#' => 'getPrimaryKeyString-detail')); ?></td>
...
<div class="detailHeader" id="enableAuditTrail-detail">
enableAuditTrail<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public bool <b>$enableAuditTrail</b>;</div>

<p>Set to false if you just want to use getDbAttribute and other methods in this class.
If left unset the value will come from YdAuditTracker::enableAuditTrail</p>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/behaviors/YdAuditBehavior.php#L55">dressing/behaviors/YdAuditBehavior.php#L55</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">__construct</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">enableAuditTrail&nbsp;</span><span style="color: #007700">===&nbsp;</span><span style="color: #0000BB">null</span><span style="color: #007700">)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">enableAuditTrail&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">app</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">auditTracker</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">enableAuditTrail</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
<p></p>
...
<tr><td colspan="3">
<div class="signature2">
public void <b>afterFind</b>($event)</div>
</td></tr>
<tr>
  <td class="paramNameCol">$event</td>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/behaviors/YdAuditBehavior.php#L256">dressing/behaviors/YdAuditBehavior.php#L256</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<tr><td colspan="3">
<div class="signature2">
public mixed <b>getDbAttribute</b>($attribute $attribute, $default $default=NULL)</div>
</td></tr>
<tr>
...
<tr>
  ...
  <td class="paramTypeCol">$default</td>
  <td class="paramDescCol"></td>
</tr>
<tr>
  <td class="paramNameCol">{return}</td>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/behaviors/YdAuditBehavior.php#L86">dressing/behaviors/YdAuditBehavior.php#L86</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="detailHeader" id="getFieldPrefix-detail">
getFieldPrefix()
<span class="detailHeaderTag">
method
</span>
...
<tr><td colspan="3">
<div class="signature2">
protected string <b>getFieldPrefix</b>($model $model)</div>
</td></tr>
<tr>
  <td class="paramNameCol">$model</td>
  <td class="paramTypeCol">$model</td>
  <td class="paramDescCol">CActiveRecord</td>
</tr>
<tr>
  <td class="paramNameCol">{return}</td>
  <td class="paramTypeCol">string</td>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/behaviors/YdAuditBehavior.php#L301">dressing/behaviors/YdAuditBehavior.php#L301</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">protected&nbsp;function&nbsp;</span><span style="color: #0000BB">getFieldPrefix</span><span style="color: #007700">(</span><span style="color: #0000BB">$model</span><span style="color: #007700">)<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #0000BB">get_class</span><span style="color: #007700">(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">owner</span><span style="color: #007700">)&nbsp;!=&nbsp;</span><span style="color: #0000BB">get_class</span><span style="color: #007700">(</span><span style="color: #0000BB">$model</span><span style="color: #007700">))&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">get_class</span><span style="color: #007700">(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">owner</span><span style="color: #007700">)&nbsp;.&nbsp;</span><span style="color: #DD0000">'.'</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #DD0000">''</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
...
<tr><td colspan="3">
<div class="signature2">
protected string <b>getPrimaryKeyString</b>($model $model)</div>
</td></tr>
<tr>
  <td class="paramNameCol">$model</td>
  <td class="paramTypeCol">$model</td>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/behaviors/YdAuditBehavior.php#L314">dressing/behaviors/YdAuditBehavior.php#L314</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">protected&nbsp;function&nbsp;</span><span style="color: #0000BB">getPrimaryKeyString</span><span style="color: #007700">(</span><span style="color: #0000BB">$model</span><span style="color: #007700">)<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #0000BB">is_array</span><span style="color: #007700">(</span><span style="color: #0000BB">$model</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getPrimaryKey</span><span style="color: #007700">()))<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">implode</span><span style="color: #007700">(</span><span style="color: #DD0000">'-'</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">$model</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getPrimaryKey</span><span style="color: #007700">());<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">$model</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getPrimaryKey</span><span style="color: #007700">();<br />}</span>
</span>
</code></div>
</div>
