<?php
$this->pageTitle = $this->pageHeading = 'YdTimestampBehavior';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'YdTimestampBehavior';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class YdTimestampBehavior &raquo;
<?php echo CHtml::link('CTimestampBehavior', array('/site/doc', 'view' => 'CTimestampBehavior')); ?> &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/behaviors/YdTimestampBehavior.php">dressing/behaviors/YdTimestampBehavior.php</a></td>
</tr>
<tr>
  <th>Authors</th>
...
<tr id="owner">
  <td><?php echo CHtml::link('owner', array('/site/doc', 'view' => 'YdTimestampBehavior', '#' => 'owner-detail')); ?></td>
  <td>ActiveRecord</td>
  <td></td>
  <td>YdTimestampBehavior</td>
</tr>
<tr id="setUpdateOnCreate">
  <td><?php echo CHtml::link('setUpdateOnCreate', array('/site/doc', 'view' => 'YdTimestampBehavior', '#' => 'setUpdateOnCreate-detail')); ?></td>
  <td>bool</td>
  <td></td>
  <td>YdTimestampBehavior</td>
</tr>
<tr class="inherited" id="timestampExpression">
...
<tr id="beforeSave">
  <td><?php echo CHtml::link('beforeSave()', array('/site/doc', 'view' => 'YdTimestampBehavior', '#' => 'beforeSave-detail')); ?></td>
...
<tr class="inherited" id="getTimestampByAttribute">
...
<tr id="getTimestampByColumnType">
  <td><?php echo CHtml::link('getTimestampByColumnType()', array('/site/doc', 'view' => 'YdTimestampBehavior', '#' => 'getTimestampByColumnType-detail')); ?></td>
...
<div class="detailHeader" id="autoColumns-detail">
autoColumns<span class="detailHeaderTag">
property
</span>
</div>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/behaviors/YdTimestampBehavior.php#L46">dressing/behaviors/YdTimestampBehavior.php#L46</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">beforeSave</span><span style="color: #007700">(</span><span style="color: #0000BB">$event</span><span style="color: #007700">)<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">_setAttributes</span><span style="color: #007700">();<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">parent</span><span style="color: #007700">::</span><span style="color: #0000BB">beforeSave</span><span style="color: #007700">(</span><span style="color: #0000BB">$event</span><span style="color: #007700">);<br />}</span>
</span>
</code></div>
</div>
<p>Responds to CModel::onBeforeSave event.
Decides if there are created/updated fields then calls parent to update them.</p>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/behaviors/YdTimestampBehavior.php#L83">dressing/behaviors/YdTimestampBehavior.php#L83</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">protected&nbsp;function&nbsp;</span><span style="color: #0000BB">getTimestampByColumnType</span><span style="color: #007700">(</span><span style="color: #0000BB">$columnType</span><span style="color: #007700">)<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #0000BB">$columnType&nbsp;</span><span style="color: #007700">==&nbsp;</span><span style="color: #DD0000">'datetime'</span><span style="color: #007700">)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'Y-m-d&nbsp;H:i:s'</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #0000BB">$columnType&nbsp;</span><span style="color: #007700">==&nbsp;</span><span style="color: #DD0000">'timestamp'</span><span style="color: #007700">)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'Y-m-d&nbsp;H:i:s'</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #0000BB">$columnType&nbsp;</span><span style="color: #007700">==&nbsp;</span><span style="color: #DD0000">'date'</span><span style="color: #007700">)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'Y-m-d'</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">time</span><span style="color: #007700">();<br />}</span>
</span>
</code></div>
</div>
