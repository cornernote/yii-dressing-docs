<?php
$this->pageTitle = $this->pageHeading = 'TbHtml5Editor';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'TbHtml5Editor';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src/widgets/TbHtml5Editor.php">booster/widgets/TbHtml5Editor.php</a></td>
</tr>
</table>
...
<br/><br/>
Implements the bootstrap-wysihtml5 editor</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'TbHtml5Editor', '#' => 'actions')); ?>.</td>
...
<tr id="editorOptions">
  <td><?php echo CHtml::link('editorOptions', array('/site/doc', 'view' => 'TbHtml5Editor', '#' => 'editorOptions-detail')); ?></td>
  <td></td>
  <td>Editor options that will be passed to the editor</td>
  <td>TbHtml5Editor</td>
</tr>
<tr id="height">
  <td><?php echo CHtml::link('height', array('/site/doc', 'view' => 'TbHtml5Editor', '#' => 'height-detail')); ?></td>
  <td></td>
  <td>Editor height</td>
  <td>TbHtml5Editor</td>
</tr>
<tr id="htmlOptions">
  <td><?php echo CHtml::link('htmlOptions', array('/site/doc', 'view' => 'TbHtml5Editor', '#' => 'htmlOptions-detail')); ?></td>
  <td></td>
  <td>Html options that will be assigned to the text area</td>
  <td>TbHtml5Editor</td>
</tr>
...
<tr id="lang">
  <td><?php echo CHtml::link('lang', array('/site/doc', 'view' => 'TbHtml5Editor', '#' => 'lang-detail')); ?></td>
  <td></td>
...
<tr id="width">
  <td><?php echo CHtml::link('width', array('/site/doc', 'view' => 'TbHtml5Editor', '#' => 'width-detail')); ?></td>
  <td></td>
  <td>Editor width</td>
  <td>TbHtml5Editor</td>
</tr>
...
<tr id="registerClientScript">
  <td><?php echo CHtml::link('registerClientScript()', array('/site/doc', 'view' => 'TbHtml5Editor', '#' => 'registerClientScript-detail')); ?></td>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'TbHtml5Editor', '#' => 'run-detail')); ?></td>
...
<div class="signature">
public <b>$editorOptions</b>;</div>

<p>Editor options that will be passed to the editor</p>
...
<div class="signature">
public <b>$htmlOptions</b>;</div>

<p>Html options that will be assigned to the text area</p>


<div class="detailHeader" id="lang-detail">
lang<span class="detailHeaderTag">
property
</span>
</div>
...
<p>Editor language
Supports: de-DE, es-ES, fr-FR, pt-BR, sv-SE, it-IT</p>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src/widgets/TbHtml5Editor.php#L74">booster/widgets/TbHtml5Editor.php#L74</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">registerClientScript</span><span style="color: #007700">(</span><span style="color: #0000BB">$id</span><span style="color: #007700">)<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">app</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">bootstrap</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">registerAssetCss</span><span style="color: #007700">(</span><span style="color: #DD0000">'bootstrap-wysihtml5.css'</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">app</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">bootstrap</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">registerAssetJs</span><span style="color: #007700">(</span><span style="color: #DD0000">'wysihtml5-0.3.0.js'</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">app</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">bootstrap</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">registerAssetJs</span><span style="color: #007700">(</span><span style="color: #DD0000">'bootstrap-wysihtml5.js'</span><span style="color: #007700">);<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(isset(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">editorOptions</span><span style="color: #007700">[</span><span style="color: #DD0000">'locale'</span><span style="color: #007700">]))&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">app</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">bootstrap</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">registerAssetJs</span><span style="color: #007700">(<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">'locales/bootstrap-wysihtml5.'&nbsp;</span><span style="color: #007700">.&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">editorOptions</span><span style="color: #007700">[</span><span style="color: #DD0000">'locale'</span><span style="color: #007700">]&nbsp;.&nbsp;</span><span style="color: #DD0000">'.js'<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;}&nbsp;elseif&nbsp;(</span><span style="color: #0000BB">in_array</span><span style="color: #007700">(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">lang</span><span style="color: #007700">,&nbsp;array(</span><span style="color: #DD0000">'de-DE'</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">'es-ES'</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">'fr'</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">'fr-NL'</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">'pt-BR'</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">'sv-SE'</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">'it-IT'</span><span style="color: #007700">)))&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">app</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">bootstrap</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">registerAssetJs</span><span style="color: #007700">(</span><span style="color: #DD0000">'locales/bootstrap-wysihtml5.'&nbsp;</span><span style="color: #007700">.&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">lang&nbsp;</span><span style="color: #007700">.&nbsp;</span><span style="color: #DD0000">'.js'</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">editorOptions</span><span style="color: #007700">[</span><span style="color: #DD0000">'locale'</span><span style="color: #007700">]&nbsp;=&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">lang</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">normalizeStylesheetsProperty</span><span style="color: #007700">();<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">insertDefaultStylesheetIfColorsEnabled</span><span style="color: #007700">();<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$options&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">CJSON</span><span style="color: #007700">::</span><span style="color: #0000BB">encode</span><span style="color: #007700">(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">editorOptions</span><span style="color: #007700">);<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$script&nbsp;</span><span style="color: #007700">=&nbsp;array();<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">/**<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;The&nbsp;default&nbsp;stylesheet&nbsp;option&nbsp;is&nbsp;incompatible&nbsp;with&nbsp;yii&nbsp;paths&nbsp;so&nbsp;it&nbsp;is&nbsp;reset&nbsp;here.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;The&nbsp;insertDefaultStylesheetIfColorsEnabled&nbsp;includes&nbsp;the&nbsp;correct&nbsp;stylesheet&nbsp;if&nbsp;needed.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;Any&nbsp;other&nbsp;changes&nbsp;to&nbsp;defaults&nbsp;should&nbsp;be&nbsp;made&nbsp;here.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*/<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$script</span><span style="color: #007700">[]&nbsp;=&nbsp;</span><span style="color: #DD0000">"$.fn.wysihtml5.defaultOptions.stylesheets&nbsp;=&nbsp;[];"</span><span style="color: #007700">;<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">/**<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;Check&nbsp;if&nbsp;we&nbsp;need&nbsp;a&nbsp;deep&nbsp;copy&nbsp;for&nbsp;the&nbsp;configuration.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*/<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #007700">if&nbsp;(isset(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">editorOptions</span><span style="color: #007700">[</span><span style="color: #DD0000">'deepExtend'</span><span style="color: #007700">])&nbsp;&amp;&amp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">editorOptions</span><span style="color: #007700">[</span><span style="color: #DD0000">'deepExtend'</span><span style="color: #007700">]&nbsp;===&nbsp;</span><span style="color: #0000BB">true</span><span style="color: #007700">)<br />&nbsp;&nbsp;&nbsp;&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$script</span><span style="color: #007700">[]&nbsp;=&nbsp;</span><span style="color: #DD0000">"$('#</span><span style="color: #007700">{</span><span style="color: #0000BB">$id</span><span style="color: #007700">}</span><span style="color: #DD0000">').wysihtml5('deepExtend',&nbsp;</span><span style="color: #007700">{</span><span style="color: #0000BB">$options</span><span style="color: #007700">}</span><span style="color: #DD0000">);"</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;else<br />&nbsp;&nbsp;&nbsp;&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$script</span><span style="color: #007700">[]&nbsp;=&nbsp;</span><span style="color: #DD0000">"$('#</span><span style="color: #007700">{</span><span style="color: #0000BB">$id</span><span style="color: #007700">}</span><span style="color: #DD0000">').wysihtml5(</span><span style="color: #007700">{</span><span style="color: #0000BB">$options</span><span style="color: #007700">}</span><span style="color: #DD0000">);"</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">app</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">getClientScript</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">registerScript</span><span style="color: #007700">(</span><span style="color: #0000BB">__CLASS__&nbsp;</span><span style="color: #007700">.&nbsp;</span><span style="color: #DD0000">'#'&nbsp;</span><span style="color: #007700">.&nbsp;</span><span style="color: #0000BB">$id</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">implode</span><span style="color: #007700">(</span><span style="color: #DD0000">"\n"</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">$script</span><span style="color: #007700">));<br />}</span>
</span>
</code></div>
</div>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src/widgets/TbHtml5Editor.php#L49">booster/widgets/TbHtml5Editor.php#L49</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
