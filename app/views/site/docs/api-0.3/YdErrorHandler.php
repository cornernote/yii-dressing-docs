...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/components/YdErrorHandler.php">dressing/components/YdErrorHandler.php</a></td>
</tr>
<tr>
  <th>Authors</th>
...
<tr id="path">
  <td><?php echo CHtml::link('path', array('/site/doc', 'view' => 'YdErrorHandler', '#' => 'path-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdErrorHandler</td>
</tr>
<tr id="string">
  <td><?php echo CHtml::link('string', array('/site/doc', 'view' => 'YdErrorHandler', '#' => 'string-detail')); ?></td>
  <td>$path</td>
  <td></td>
  <td>YdErrorHandler</td>
</tr>
<tr id="string|int">
  <td><?php echo CHtml::link('int', array('/site/doc', 'view' => 'YdErrorHandler', '#' => 'string|int-detail|string')); ?></td>
  <td>$auditId</td>
  <td></td>
  <td>YdErrorHandler</td>
</tr>
...
<tr id="getPath">
  <td><?php echo CHtml::link('getPath()', array('/site/doc', 'view' => 'YdErrorHandler', '#' => 'getPath-detail')); ?></td>
  <td></td>
  <td>YdErrorHandler</td>
</tr>
<tr id="handle">
...
<tr id="setPath">
  <td><?php echo CHtml::link('setPath()', array('/site/doc', 'view' => 'YdErrorHandler', '#' => 'setPath-detail')); ?></td>
  <td>Sets string</td>
  <td>YdErrorHandler</td>
</tr>
</table>
...
<div class="signature">
public string <?php echo CHtml::link('<b>getPath</b>', array('/site/doc', 'view' => 'YdErrorHandler', '#' => 'getPath')); ?>()<br/>public void <?php echo CHtml::link('<b>setPath</b>', array('/site/doc', 'view' => 'YdErrorHandler', '#' => 'setPath')); ?>($path $path)</div>

<p></p>


<div class="detailHeader" id="string-detail">
...
<div class="detailHeader" id="string|int-detail">
string|int<span class="detailHeaderTag">
property
</span>
</div>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/components/YdErrorHandler.php#L60">dressing/components/YdErrorHandler.php#L60</a> (<b><a href="#" class="show">show</a></b>)
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/components/YdErrorHandler.php#L133">dressing/components/YdErrorHandler.php#L133</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/components/YdErrorHandler.php#L203">dressing/components/YdErrorHandler.php#L203</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">getPath</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">_path</span><span style="color: #007700">)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">_path</span><span style="color: #007700">;<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">_path&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">app</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">getRuntimePath</span><span style="color: #007700">()&nbsp;.&nbsp;</span><span style="color: #0000BB">DS&nbsp;</span><span style="color: #007700">.&nbsp;</span><span style="color: #DD0000">'errors'</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(!</span><span style="color: #0000BB">file_exists</span><span style="color: #007700">(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">_path</span><span style="color: #007700">))<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">mkdir</span><span style="color: #007700">(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">_path</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">0777</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">true</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">_path</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
<p></p>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/components/YdErrorHandler.php#L27">dressing/components/YdErrorHandler.php#L27</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/components/YdErrorHandler.php#L49">dressing/components/YdErrorHandler.php#L49</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<tr><td colspan="3">
<div class="signature2">
public void <b>setPath</b>($path $path)</div>
</td></tr>
<tr>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/components/YdErrorHandler.php#L217">dressing/components/YdErrorHandler.php#L217</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">setPath</span><span style="color: #007700">(</span><span style="color: #0000BB">$path</span><span style="color: #007700">)<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">_path&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">$path</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
<p></p>
