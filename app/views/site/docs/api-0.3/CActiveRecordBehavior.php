...
<tr>
  <th>Subclasses</th>
  <td><?php echo CHtml::link('CTimestampBehavior', array('/site/doc', 'view' => 'CTimestampBehavior')); ?>, <?php echo CHtml::link('YdAuditBehavior', array('/site/doc', 'view' => 'YdAuditBehavior')); ?>, <?php echo CHtml::link('YdCacheBehavior', array('/site/doc', 'view' => 'YdCacheBehavior')); ?>, <?php echo CHtml::link('YdEavBehavior', array('/site/doc', 'view' => 'YdEavBehavior')); ?>, <?php echo CHtml::link('YdLinkBehavior', array('/site/doc', 'view' => 'YdLinkBehavior')); ?>, <?php echo CHtml::link('YdSoftDeleteBehavior', array('/site/doc', 'view' => 'YdSoftDeleteBehavior')); ?></td>
</tr>
<tr>
  <th>Source Code</th>
