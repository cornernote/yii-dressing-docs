...
<tr>
  <th>Subclasses</th>
  <td><?php echo CHtml::link('CActiveRecordBehavior', array('/site/doc', 'view' => 'CActiveRecordBehavior')); ?>, <?php echo CHtml::link('CBehavior', array('/site/doc', 'view' => 'CBehavior')); ?>, <?php echo CHtml::link('CConsoleCommandBehavior', array('/site/doc', 'view' => 'CConsoleCommandBehavior')); ?>, <?php echo CHtml::link('CModelBehavior', array('/site/doc', 'view' => 'CModelBehavior')); ?>, <?php echo CHtml::link('CTimestampBehavior', array('/site/doc', 'view' => 'CTimestampBehavior')); ?>, <?php echo CHtml::link('YdAuditBehavior', array('/site/doc', 'view' => 'YdAuditBehavior')); ?>, <?php echo CHtml::link('YdCacheBehavior', array('/site/doc', 'view' => 'YdCacheBehavior')); ?>, <?php echo CHtml::link('YdEavAuditBehavior', array('/site/doc', 'view' => 'YdEavAuditBehavior')); ?>, <?php echo CHtml::link('YdEavBehavior', array('/site/doc', 'view' => 'YdEavBehavior')); ?>, <?php echo CHtml::link('YdLinkBehavior', array('/site/doc', 'view' => 'YdLinkBehavior')); ?>, <?php echo CHtml::link('YdSoftDeleteBehavior', array('/site/doc', 'view' => 'YdSoftDeleteBehavior')); ?>, <?php echo CHtml::link('YdTimestampBehavior', array('/site/doc', 'view' => 'YdTimestampBehavior')); ?>, <?php echo CHtml::link('YdWebUserFlashBehavior', array('/site/doc', 'view' => 'YdWebUserFlashBehavior')); ?></td>
</tr>
<tr>
  <th>Source Code</th>
