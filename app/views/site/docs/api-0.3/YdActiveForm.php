...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/widgets/YdActiveForm.php">dressing/widgets/YdActiveForm.php</a></td>
</tr>
<tr>
  <th>Authors</th>
...
<tr id="submitButton">
  <td><?php echo CHtml::link('submitButton', array('/site/doc', 'view' => 'YdActiveForm', '#' => 'submitButton-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdActiveForm</td>
</tr>
<tr id="submitButtonRow">
  <td><?php echo CHtml::link('submitButtonRow', array('/site/doc', 'view' => 'YdActiveForm', '#' => 'submitButtonRow-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdActiveForm</td>
</tr>
...
submitButton<span class="detailHeaderTag">
property
 <em>read-only</em> </span>
</div>

<div class="signature">
public string <?php echo CHtml::link('<b>getSubmitButton</b>', array('/site/doc', 'view' => 'YdActiveForm', '#' => 'getSubmitButton')); ?>(string $label=NULL, $options=array (
))</div>

<p></p>


<div class="detailHeader" id="submitButtonRow-detail">
submitButtonRow<span class="detailHeaderTag">
property
 <em>read-only</em> </span>
</div>

<div class="signature">
public string <?php echo CHtml::link('<b>getSubmitButtonRow</b>', array('/site/doc', 'view' => 'YdActiveForm', '#' => 'getSubmitButtonRow')); ?>(string $label=NULL, $options=array (
))</div>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/widgets/YdActiveForm.php#L67">dressing/widgets/YdActiveForm.php#L67</a> (<b><a href="#" class="show">show</a></b>)
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/widgets/YdActiveForm.php#L79">dressing/widgets/YdActiveForm.php#L79</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/widgets/YdActiveForm.php#L119">dressing/widgets/YdActiveForm.php#L119</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<tr><td colspan="3">
<div class="signature2">
public string <b>getSubmitButton</b>(string $label=NULL, $options=array (
))</div>
</td></tr>
<tr>
...
<tr><td colspan="3">
<div class="signature2">
public string <b>getSubmitButtonRow</b>(string $label=NULL, $options=array (
))</div>
</td></tr>
<tr>
  <td class="paramNameCol">$label</td>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/widgets/YdActiveForm.php#L152">dressing/widgets/YdActiveForm.php#L152</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/widgets/YdActiveForm.php#L91">dressing/widgets/YdActiveForm.php#L91</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/widgets/YdActiveForm.php#L37">dressing/widgets/YdActiveForm.php#L37</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/widgets/YdActiveForm.php#L100">dressing/widgets/YdActiveForm.php#L100</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
