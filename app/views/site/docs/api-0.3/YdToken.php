<?php
$this->pageTitle = $this->pageHeading = 'YdToken';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'YdToken';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/models/YdToken.php">dressing/models/YdToken.php</a></td>
</tr>
<tr>
  <th>Authors</th>
...
<br/><br/>
This is the model class for table 'token'</div>
<a name="properties"></a>
...
<tr id="created">
  <td><?php echo CHtml::link('created', array('/site/doc', 'view' => 'YdToken', '#' => 'created-detail')); ?></td>
  <td>datetime</td>
  <td></td>
  <td>YdToken</td>
</tr>
...
<tr id="expires">
  <td><?php echo CHtml::link('expires', array('/site/doc', 'view' => 'YdToken', '#' => 'expires-detail')); ?></td>
  <td>datetime</td>
  <td></td>
  <td>YdToken</td>
</tr>
<tr id="id">
  <td><?php echo CHtml::link('id', array('/site/doc', 'view' => 'YdToken', '#' => 'id-detail')); ?></td>
  <td>integer</td>
  <td></td>
  <td>YdToken</td>
</tr>
...
<tr id="model">
  <td><?php echo CHtml::link('model', array('/site/doc', 'view' => 'YdToken', '#' => 'model-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdToken</td>
</tr>
<tr id="model_id">
  <td><?php echo CHtml::link('model_id', array('/site/doc', 'view' => 'YdToken', '#' => 'model_id-detail')); ?></td>
  <td>integer</td>
  <td></td>
  <td>YdToken</td>
</tr>
...
<tr id="token">
  <td><?php echo CHtml::link('token', array('/site/doc', 'view' => 'YdToken', '#' => 'token-detail')); ?></td>
  <td>string</td>
  <td></td>
  <td>YdToken</td>
</tr>
<tr id="uses_allowed">
  <td><?php echo CHtml::link('uses_allowed', array('/site/doc', 'view' => 'YdToken', '#' => 'uses_allowed-detail')); ?></td>
  <td>integer</td>
  <td></td>
  <td>YdToken</td>
</tr>
<tr id="uses_remaining">
  <td><?php echo CHtml::link('uses_remaining', array('/site/doc', 'view' => 'YdToken', '#' => 'uses_remaining-detail')); ?></td>
  <td>integer</td>
  <td></td>
  <td>YdToken</td>
</tr>
...
<tr class="inherited" id="validators">
  ...
  <td>array</td>
  <td>Returns the validators applicable to the current <?php echo CHtml::link('scenario', array('/site/doc', 'view' => 'YdToken', '#' => 'scenario')); ?>.</td>
  <td><?php echo CHtml::link('CModel', array('/site/doc', 'view' => 'CModel')); ?></td>
</tr>
</table>
</div>
...
<tr id="add">
  <td><?php echo CHtml::link('add()', array('/site/doc', 'view' => 'YdToken', '#' => 'add-detail')); ?></td>
  <td></td>
  <td>YdToken</td>
</tr>
...
<tr class="inherited" id="afterFindInternal">
  ...
  <td>Calls <?php echo CHtml::link('afterFind', array('/site/doc', 'view' => 'YdToken', '#' => 'afterFind')); ?>.</td>
  <td><?php echo CHtml::link('CActiveRecord', array('/site/doc', 'view' => 'CActiveRecord')); ?></td>
</tr>
...
<tr id="attributeLabels">
  <td><?php echo CHtml::link('attributeLabels()', array('/site/doc', 'view' => 'YdToken', '#' => 'attributeLabels-detail')); ?></td>
  <td></td>
  <td>YdToken</td>
</tr>
...
<tr class="inherited" id="beforeFindInternal">
  ...
  <td>Calls <?php echo CHtml::link('beforeFind', array('/site/doc', 'view' => 'YdToken', '#' => 'beforeFind')); ?>.</td>
  <td><?php echo CHtml::link('CActiveRecord', array('/site/doc', 'view' => 'CActiveRecord')); ?></td>
</tr>
...
<tr id="checkToken">
  <td><?php echo CHtml::link('checkToken()', array('/site/doc', 'view' => 'YdToken', '#' => 'checkToken-detail')); ?></td>
  <td></td>
  <td>YdToken</td>
</tr>
...
<tr class="inherited" id="createValidators">
  ...
  <td>Creates validator objects based on the specification in <?php echo CHtml::link('rules', array('/site/doc', 'view' => 'YdToken', '#' => 'rules')); ?>.</td>
  <td><?php echo CHtml::link('CModel', array('/site/doc', 'view' => 'CModel')); ?></td>
</tr>
...
<tr id="hashToken">
  <td><?php echo CHtml::link('hashToken()', array('/site/doc', 'view' => 'YdToken', '#' => 'hashToken-detail')); ?></td>
  <td>Determines creates a token hash</td>
  <td>YdToken</td>
</tr>
...
<tr id="model">
  <td><?php echo CHtml::link('model()', array('/site/doc', 'view' => 'YdToken', '#' => 'model-detail')); ?></td>
...
<tr id="useToken">
  <td><?php echo CHtml::link('useToken()', array('/site/doc', 'view' => 'YdToken', '#' => 'useToken-detail')); ?></td>
  <td></td>
  <td>YdToken</td>
</tr>
...
<tr id="validateToken">
  <td><?php echo CHtml::link('validateToken()', array('/site/doc', 'view' => 'YdToken', '#' => 'validateToken-detail')); ?></td>
  <td></td>
  <td>YdToken</td>
</tr>
...
<div class="detailHeader" id="expires-detail">
expires<span class="detailHeaderTag">
property
</span>
</div>
...
<div class="detailHeader" id="token-detail">
token<span class="detailHeaderTag">
property
</span>
</div>
...
<div class="detailHeader" id="uses_allowed-detail">
uses_allowed<span class="detailHeaderTag">
property
</span>
</div>
...
<div class="signature">
integer <b>uses_allowed</b>;</div>

<p></p>


<div class="detailHeader" id="uses_remaining-detail">
uses_remaining<span class="detailHeaderTag">
property
</span>
</div>
...
public string <b>add</b>($expires $expires, $uses_allowed $uses_allowed, $relation $relation)</div>
</td></tr>
<tr>
  <td class="paramNameCol">$expires</td>
  <td class="paramTypeCol">$expires</td>
  <td class="paramDescCol"></td>
</tr>
<tr>
  <td class="paramNameCol">$uses_allowed</td>
  <td class="paramTypeCol">$uses_allowed</td>
  <td class="paramDescCol"></td>
</tr>
<tr>
  <td class="paramNameCol">$relation</td>
  <td class="paramTypeCol">$relation</td>
  <td class="paramDescCol"></td>
</tr>
<tr>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/models/YdToken.php#L69">dressing/models/YdToken.php#L69</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">add</span><span style="color: #007700">(</span><span style="color: #0000BB">$expires</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">$uses_allowed</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">$relation</span><span style="color: #007700">)<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$plain&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">md5</span><span style="color: #007700">(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">hashToken</span><span style="color: #007700">(</span><span style="color: #0000BB">uniqid</span><span style="color: #007700">(</span><span style="color: #0000BB">true</span><span style="color: #007700">)));<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$token&nbsp;</span><span style="color: #007700">=&nbsp;new&nbsp;</span><span style="color: #0000BB">YdToken</span><span style="color: #007700">();<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$token</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">uses_allowed&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">$uses_allowed</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$token</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">uses_remaining&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">$uses_allowed</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$token</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">expires&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">YdTime</span><span style="color: #007700">::</span><span style="color: #0000BB">datetime</span><span style="color: #007700">(</span><span style="color: #0000BB">$expires</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$token</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">model&nbsp;</span><span style="color: #007700">=&nbsp;!empty(</span><span style="color: #0000BB">$relation</span><span style="color: #007700">[</span><span style="color: #DD0000">'model'</span><span style="color: #007700">])&nbsp;?&nbsp;</span><span style="color: #0000BB">$relation</span><span style="color: #007700">[</span><span style="color: #DD0000">'model'</span><span style="color: #007700">]&nbsp;:&nbsp;</span><span style="color: #DD0000">''</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$token</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">model_id&nbsp;</span><span style="color: #007700">=&nbsp;!empty(</span><span style="color: #0000BB">$relation</span><span style="color: #007700">[</span><span style="color: #DD0000">'model_id'</span><span style="color: #007700">])&nbsp;?&nbsp;</span><span style="color: #0000BB">$relation</span><span style="color: #007700">[</span><span style="color: #DD0000">'model_id'</span><span style="color: #007700">]&nbsp;:&nbsp;</span><span style="color: #DD0000">''</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$token</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">token&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">hashToken</span><span style="color: #007700">(</span><span style="color: #0000BB">$plain</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$token</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">created&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">date</span><span style="color: #007700">(</span><span style="color: #DD0000">'Y-m-d&nbsp;H:i:s'</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$token</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">save</span><span style="color: #007700">();<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">$plain</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
<p></p>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/models/YdToken.php#L56">dressing/models/YdToken.php#L56</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="detailHeader" id="checkToken-detail">
checkToken()
<span class="detailHeaderTag">
method
</span>
...
<tr><td colspan="3">
<div class="signature2">
public YdToken <b>checkToken</b>($model $model, $model_id $model_id, $plain $plain)</div>
</td></tr>
<tr>
...
<tr>
  <td class="paramNameCol">$model_id</td>
  <td class="paramTypeCol">$model_id</td>
  <td class="paramDescCol"></td>
</tr>
<tr>
...
<tr>
  <td class="paramNameCol">{return}</td>
  <td class="paramTypeCol">YdToken</td>
  <td class="paramDescCol"></td>
</tr>
</table>

<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/models/YdToken.php#L90">dressing/models/YdToken.php#L90</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">checkToken</span><span style="color: #007700">(</span><span style="color: #0000BB">$model</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">$model_id</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">$plain</span><span style="color: #007700">)<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;check&nbsp;for&nbsp;valid&nbsp;token<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$token&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">self</span><span style="color: #007700">::</span><span style="color: #0000BB">model</span><span style="color: #007700">()-&gt;</span><span style="color: #0000BB">find</span><span style="color: #007700">(</span><span style="color: #DD0000">"model=:model&nbsp;AND&nbsp;model_id=:model_id&nbsp;ORDER&nbsp;BY&nbsp;t.created&nbsp;DESC,&nbsp;t.id&nbsp;DESC"</span><span style="color: #007700">,&nbsp;array(<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">':model'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #0000BB">$model</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #DD0000">':model_id'&nbsp;</span><span style="color: #007700">=&gt;&nbsp;</span><span style="color: #0000BB">$model_id</span><span style="color: #007700">,<br />&nbsp;&nbsp;&nbsp;&nbsp;));<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(!</span><span style="color: #0000BB">$token</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addError</span><span style="color: #007700">(</span><span style="color: #DD0000">'token'</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">t</span><span style="color: #007700">(</span><span style="color: #DD0000">'dressing'</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">'missing&nbsp;token'</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">false</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;check&nbsp;uses&nbsp;remaining<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #007700">if&nbsp;(</span><span style="color: #0000BB">$token</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">uses_remaining&nbsp;</span><span style="color: #007700">&lt;=&nbsp;</span><span style="color: #0000BB">0</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addError</span><span style="color: #007700">(</span><span style="color: #DD0000">'token'</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">t</span><span style="color: #007700">(</span><span style="color: #DD0000">'dressing'</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">'no&nbsp;uses&nbsp;remaining'</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">false</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;check&nbsp;expires<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #007700">if&nbsp;(</span><span style="color: #0000BB">strtotime</span><span style="color: #007700">(</span><span style="color: #0000BB">$token</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">expires</span><span style="color: #007700">)&nbsp;&lt;=&nbsp;</span><span style="color: #0000BB">time</span><span style="color: #007700">())&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addError</span><span style="color: #007700">(</span><span style="color: #DD0000">'token'</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">t</span><span style="color: #007700">(</span><span style="color: #DD0000">'dressing'</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">'token&nbsp;has&nbsp;expired'</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">false</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;check&nbsp;token&nbsp;plain<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #007700">if&nbsp;(!</span><span style="color: #0000BB">$token</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">validateToken</span><span style="color: #007700">(</span><span style="color: #0000BB">$plain</span><span style="color: #007700">))&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">addError</span><span style="color: #007700">(</span><span style="color: #DD0000">'token'</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">Yii</span><span style="color: #007700">::</span><span style="color: #0000BB">t</span><span style="color: #007700">(</span><span style="color: #DD0000">'dressing'</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">'token&nbsp;is&nbsp;invalid'</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">false</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">$token</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
<p></p>
...
<div class="detailHeader" id="hashToken-detail">
hashToken()
<span class="detailHeaderTag">
method
</span>
...
<tr><td colspan="3">
<div class="signature2">
public string <b>hashToken</b>($plain $plain)</div>
</td></tr>
<tr>
  <td class="paramNameCol">$plain</td>
  <td class="paramTypeCol">$plain</td>
...
<tr><td colspan="3">
<div class="signature2">
public static YdToken <b>model</b>(string $className='YdToken')</div>
</td></tr>
<tr>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/models/YdToken.php#L48">dressing/models/YdToken.php#L48</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<div class="detailHeader" id="useToken-detail">
useToken()
<span class="detailHeaderTag">
method
</span>
...
<tr><td colspan="3">
<div class="signature2">
public bool <b>useToken</b>($model $model, $model_id $model_id, $plain $plain)</div>
</td></tr>
<tr>
  <td class="paramNameCol">$model</td>
  <td class="paramTypeCol">$model</td>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/models/YdToken.php#L125">dressing/models/YdToken.php#L125</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">useToken</span><span style="color: #007700">(</span><span style="color: #0000BB">$model</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">$model_id</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">$plain</span><span style="color: #007700">)<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$token&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">checkToken</span><span style="color: #007700">(</span><span style="color: #0000BB">$model</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">$model_id</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">$plain</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(!</span><span style="color: #0000BB">$token</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">false</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;deduct&nbsp;from&nbsp;uses&nbsp;remaining<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$token</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">uses_remaining</span><span style="color: #007700">--;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$token</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">save</span><span style="color: #007700">(</span><span style="color: #0000BB">false</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;</span><span style="color: #0000BB">true</span><span style="color: #007700">;<br />}</span>
</span>
</code></div>
</div>
<p></p>
...
<div class="detailHeader" id="validateToken-detail">
validateToken()
<span class="detailHeaderTag">
method
</span>
...
<tr><td colspan="3">
<div class="signature2">
public boolean <b>validateToken</b>($plain $plain, null $encrypted=NULL)</div>
</td></tr>
<tr>
  <td class="paramNameCol">$plain</td>
  <td class="paramTypeCol">$plain</td>
...
<tr>
  ...
  <td class="paramDescCol">validates a token</td>
</tr>
</table>

<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/cornernote/yii-dressing/blob/yii-dressing-0.3.0/yii-dressing/models/YdToken.php#L142">dressing/models/YdToken.php#L142</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
