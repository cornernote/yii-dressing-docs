<?php
$this->pageTitle = $this->pageHeading = 'CJuiProgressBar';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CJuiProgressBar';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CJuiProgressBar &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/zii/widgets/jui/CJuiProgressBar.php">yii/zii/widgets/jui/CJuiProgressBar.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
<br/><br/>
CJuiProgressBar encapsulates the <a href="http://jqueryui.com/progressbar/">JUI
Progressbar</a> plugin.
<br/><br/>
...
<br/><br/>
By configuring the <?php echo CHtml::link('options', array('/site/doc', 'view' => 'CJuiProgressBar', '#' => 'options')); ?> property, you may specify the options
that need to be passed to the JUI progressbar plugin. Please refer to
the <a href="http://api.jqueryui.com/progressbar/">JUI ProgressBar</a> documentation
for possible options (name-value pairs) and
<a href="http://jqueryui.com/progressbar/">JUI ProgressBar page</a> for general
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'CJuiProgressBar', '#' => 'actions')); ?>.</td>
...
<tr id="tagName">
  <td><?php echo CHtml::link('tagName', array('/site/doc', 'view' => 'CJuiProgressBar', '#' => 'tagName-detail')); ?></td>
  <td>string</td>
  <td>the name of the container element that contains the progress bar.</td>
  <td>CJuiProgressBar</td>
</tr>
...
<tr id="value">
  <td><?php echo CHtml::link('value', array('/site/doc', 'view' => 'CJuiProgressBar', '#' => 'value-detail')); ?></td>
  <td>integer</td>
  <td>the percentage of the progress.</td>
  <td>CJuiProgressBar</td>
</tr>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'CJuiProgressBar', '#' => 'run-detail')); ?></td>
...
<tr class="inherited" id="registerScriptFile">
  ...
  <td>Registers a JavaScript file under <?php echo CHtml::link('scriptUrl', array('/site/doc', 'view' => 'CJuiProgressBar', '#' => 'scriptUrl')); ?>.</td>
  <td><?php echo CHtml::link('CJuiWidget', array('/site/doc', 'view' => 'CJuiWidget')); ?></td>
</tr>
...
<p>the name of the container element that contains the progress bar. Defaults to 'div'.</p>
...
<p>the percentage of the progress. This must be an integer between 0 and 100. Defaults to 0.</p>
