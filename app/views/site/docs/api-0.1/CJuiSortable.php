<?php
$this->pageTitle = $this->pageHeading = 'CJuiSortable';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CJuiSortable';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/zii/widgets/jui/CJuiSortable.php">yii/zii/widgets/jui/CJuiSortable.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
<br/><br/>
CJuiSortable encapsulates the <a href="http://jqueryui.com/sortable/">JUI Sortable</a>
plugin.
<br/><br/>
...
<br/><br/>
By configuring the <?php echo CHtml::link('options', array('/site/doc', 'view' => 'CJuiSortable', '#' => 'options')); ?> property, you may specify the options
that need to be passed to the JUI Sortable plugin. Please refer to
the <a href="http://api.jqueryui.com/sortable/">JUI Sortable API</a> documentation
for possible options (name-value pairs) and
<a href="http://jqueryui.com/sortable/">JUI Sortable page</a> for general
description and demo.
<br/><br/>
If you are using JavaScript expressions anywhere in the code, please wrap it
with <?php echo CHtml::link('CJavaScriptExpression', array('/site/doc', 'view' => 'CJavaScriptExpression')); ?> and Yii will use it as code.</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'CJuiSortable', '#' => 'actions')); ?>.</td>
...
<tr id="itemTemplate">
  <td><?php echo CHtml::link('itemTemplate', array('/site/doc', 'view' => 'CJuiSortable', '#' => 'itemTemplate-detail')); ?></td>
  <td>string</td>
  <td>the template that is used to generated every sortable item.</td>
  <td>CJuiSortable</td>
</tr>
<tr id="items">
  <td><?php echo CHtml::link('items', array('/site/doc', 'view' => 'CJuiSortable', '#' => 'items-detail')); ?></td>
  <td>array</td>
  <td>list of sortable items (id=>item content).</td>
  <td>CJuiSortable</td>
</tr>
...
<tr id="tagName">
  <td><?php echo CHtml::link('tagName', array('/site/doc', 'view' => 'CJuiSortable', '#' => 'tagName-detail')); ?></td>
  <td>string</td>
  <td>the name of the container element that contains all items.</td>
  <td>CJuiSortable</td>
</tr>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'CJuiSortable', '#' => 'run-detail')); ?></td>
...
<tr class="inherited" id="registerScriptFile">
  ...
  <td>Registers a JavaScript file under <?php echo CHtml::link('scriptUrl', array('/site/doc', 'view' => 'CJuiSortable', '#' => 'scriptUrl')); ?>.</td>
  <td><?php echo CHtml::link('CJuiWidget', array('/site/doc', 'view' => 'CJuiWidget')); ?></td>
</tr>
...
<p>the template that is used to generated every sortable item.
The token "{content}" in the template will be replaced with the item content,
while "{id}" be replaced with the item ID.</p>
...
<p>list of sortable items (id=>item content).
Note that the item contents will not be HTML-encoded.</p>
...
<p>the name of the container element that contains all items. Defaults to 'ul'.</p>
