<?php
$this->pageTitle = $this->pageHeading = 'TbPickerColumn';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'TbPickerColumn';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src/widgets/TbPickerColumn.php">booster/widgets/TbPickerColumn.php</a></td>
</tr>
</table>
...
<tr id="class">
  <td><?php echo CHtml::link('class', array('/site/doc', 'view' => 'TbPickerColumn', '#' => 'class-detail')); ?></td>
  <td>string</td>
  <td>$class the class name to use to display picker</td>
  <td>TbPickerColumn</td>
</tr>
...
<tr id="pickerOptions">
  <td><?php echo CHtml::link('pickerOptions', array('/site/doc', 'view' => 'TbPickerColumn', '#' => 'pickerOptions-detail')); ?></td>
  <td>array</td>
...
<tr class="inherited" id="value">
  ...
  <td>string</td>
  <td>a PHP expression that will be evaluated for every data cell using <?php echo CHtml::link('evaluateExpression', array('/site/doc', 'view' => 'TbPickerColumn', '#' => 'evaluateExpression')); ?> and whose result will be rendered
...
This is determined based on whether <?php echo CHtml::link('footer', array('/site/doc', 'view' => 'TbPickerColumn', '#' => 'footer')); ?> is set.</td>
  <td><?php echo CHtml::link('CGridColumn', array('/site/doc', 'view' => 'CGridColumn')); ?></td>
</tr>
...
<tr id="init">
  <td><?php echo CHtml::link('init()', array('/site/doc', 'view' => 'TbPickerColumn', '#' => 'init-detail')); ?></td>
...
<tr id="registerClientScript">
  <td><?php echo CHtml::link('registerClientScript()', array('/site/doc', 'view' => 'TbPickerColumn', '#' => 'registerClientScript-detail')); ?></td>
...
<tr id="renderDataCellContent">
  <td><?php echo CHtml::link('renderDataCellContent()', array('/site/doc', 'view' => 'TbPickerColumn', '#' => 'renderDataCellContent-detail')); ?></td>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src/widgets/TbPickerColumn.php#L40">booster/widgets/TbPickerColumn.php#L40</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">init</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(!</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">class</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">class&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #DD0000">'bootstrap-picker'</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">registerClientScript</span><span style="color: #007700">();<br />}</span>
</span>
</code></div>
</div>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/clevertech/YiiBooster/blob/master/src/widgets/TbPickerColumn.php#L73">booster/widgets/TbPickerColumn.php#L73</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
...
<tr><td colspan="3">
<div class="signature2">
public void <b>renderDataCellContent</b>(int $row, mixed $data)</div>
</td></tr>
<tr>
