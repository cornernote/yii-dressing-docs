<?php
$this->pageTitle = $this->pageHeading = 'CUniqueValidator';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CUniqueValidator';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CUniqueValidator &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/validators/CUniqueValidator.php">yii/validators/CUniqueValidator.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
<br/><br/>
When using the <?php echo CHtml::link('message', array('/site/doc', 'view' => 'CUniqueValidator', '#' => 'message')); ?> property to define a custom error message, the message
...
<tr id="allowEmpty">
  <td><?php echo CHtml::link('allowEmpty', array('/site/doc', 'view' => 'CUniqueValidator', '#' => 'allowEmpty-detail')); ?></td>
  <td>boolean</td>
  <td>whether the attribute value can be null or empty.</td>
  <td>CUniqueValidator</td>
</tr>
<tr id="attributeName">
  <td><?php echo CHtml::link('attributeName', array('/site/doc', 'view' => 'CUniqueValidator', '#' => 'attributeName-detail')); ?></td>
  <td>string</td>
...
<tr id="caseSensitive">
  <td><?php echo CHtml::link('caseSensitive', array('/site/doc', 'view' => 'CUniqueValidator', '#' => 'caseSensitive-detail')); ?></td>
  <td>boolean</td>
  <td>whether the comparison is case sensitive.</td>
  <td>CUniqueValidator</td>
</tr>
<tr id="className">
  <td><?php echo CHtml::link('className', array('/site/doc', 'view' => 'CUniqueValidator', '#' => 'className-detail')); ?></td>
  <td>string</td>
...
<tr id="criteria">
  <td><?php echo CHtml::link('criteria', array('/site/doc', 'view' => 'CUniqueValidator', '#' => 'criteria-detail')); ?></td>
  <td>mixed</td>
...
<tr id="message">
  <td><?php echo CHtml::link('message', array('/site/doc', 'view' => 'CUniqueValidator', '#' => 'message-detail')); ?></td>
  <td>string</td>
...
<tr id="skipOnError">
  <td><?php echo CHtml::link('skipOnError', array('/site/doc', 'view' => 'CUniqueValidator', '#' => 'skipOnError-detail')); ?></td>
  <td>boolean</td>
  <td>whether this validation rule should be skipped if when there is already a validation
...
<tr id="getModel">
  <td><?php echo CHtml::link('getModel()', array('/site/doc', 'view' => 'CUniqueValidator', '#' => 'getModel-detail')); ?></td>
...
<tr id="validateAttribute">
  <td><?php echo CHtml::link('validateAttribute()', array('/site/doc', 'view' => 'CUniqueValidator', '#' => 'validateAttribute-detail')); ?></td>
...
<h4>See Also</h4>
<ul>
	<li><?php echo CHtml::link('className', array('/site/doc', 'view' => 'CUniqueValidator', '#' => 'className')); ?></li>
</ul>
</div>
...
<h4>See Also</h4>
<ul>
	<li><?php echo CHtml::link('attributeName', array('/site/doc', 'view' => 'CUniqueValidator', '#' => 'attributeName')); ?></li>
</ul>
</div>
...
<p>the user-defined error message. The placeholders "{attribute}" and "{value}"
are recognized, which will be replaced with the actual attribute name and value, respectively.</p>
...
<p>whether this validation rule should be skipped if when there is already a validation
error for the current attribute. Defaults to true.</p>
...
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/validators/CUniqueValidator.php#L146">yii/validators/CUniqueValidator.php#L146</a> (<b><a href="#" class="show">show</a></b>)
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/validators/CUniqueValidator.php#L80">yii/validators/CUniqueValidator.php#L80</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
