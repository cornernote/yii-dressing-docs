<?php
$this->pageTitle = $this->pageHeading = 'CJuiAutoComplete';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CJuiAutoComplete';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CJuiAutoComplete &raquo;
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/zii/widgets/jui/CJuiAutoComplete.php">yii/zii/widgets/jui/CJuiAutoComplete.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
<br/><br/>
CJuiAutoComplete encapsulates the <a href="http://jqueryui.com/autocomplete/">JUI
...
<br/><br/>
By configuring the <?php echo CHtml::link('options', array('/site/doc', 'view' => 'CJuiAutoComplete', '#' => 'options')); ?> property, you may specify the options
that need to be passed to the JUI autocomplete plugin. Please refer to
the <a href="http://api.jqueryui.com/autocomplete/">JUI AutoComplete API</a>
documentation for possible options (name-value pairs) and
<a href="http://jqueryui.com/autocomplete/">JUI AutoComplete page</a> for
general description and demo.
<br/><br/>
By configuring the <?php echo CHtml::link('source', array('/site/doc', 'view' => 'CJuiAutoComplete', '#' => 'source')); ?> property, you may specify where to search
the autocomplete options for each item. If source is an array, the list is
used for autocomplete. You may also configure <?php echo CHtml::link('sourceUrl', array('/site/doc', 'view' => 'CJuiAutoComplete', '#' => 'sourceUrl')); ?> to retrieve
autocomplete items from an ajax response.</div>
<a name="properties"></a>
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'CJuiAutoComplete', '#' => 'actions')); ?>.</td>
...
<tr id="source">
  <td><?php echo CHtml::link('source', array('/site/doc', 'view' => 'CJuiAutoComplete', '#' => 'source-detail')); ?></td>
  <td>mixed</td>
  <td>the entries that the autocomplete should choose from.</td>
  <td>CJuiAutoComplete</td>
</tr>
<tr id="sourceUrl">
  <td><?php echo CHtml::link('sourceUrl', array('/site/doc', 'view' => 'CJuiAutoComplete', '#' => 'sourceUrl-detail')); ?></td>
  <td>mixed</td>
  <td>the URL that will return JSON data as the autocomplete items.</td>
  <td>CJuiAutoComplete</td>
</tr>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'CJuiAutoComplete', '#' => 'run-detail')); ?></td>
...
<tr class="inherited" id="registerScriptFile">
  ...
  <td>Registers a JavaScript file under <?php echo CHtml::link('scriptUrl', array('/site/doc', 'view' => 'CJuiAutoComplete', '#' => 'scriptUrl')); ?>.</td>
  <td><?php echo CHtml::link('CJuiWidget', array('/site/doc', 'view' => 'CJuiWidget')); ?></td>
</tr>
...
<p>the entries that the autocomplete should choose from. This can be
<ul>
...
<?php echo CHtml::link('CJavaScriptExpression', array('/site/doc', 'view' => 'CJavaScriptExpression')); ?> in this case.</li>
</ul></p>


<div class="detailHeader" id="sourceUrl-detail">
sourceUrl<span class="detailHeaderTag">
property
</span>
</div>

<div class="signature">
public mixed <b>$sourceUrl</b>;</div>

<p>the URL that will return JSON data as the autocomplete items.
CHtml::normalizeUrl() will be applied to this property to convert the property
into a proper URL. When this property is set, the <?php echo CHtml::link('source', array('/site/doc', 'view' => 'CJuiAutoComplete', '#' => 'source')); ?> property will be ignored.</p>
