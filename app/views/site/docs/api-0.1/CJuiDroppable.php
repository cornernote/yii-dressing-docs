<?php
$this->pageTitle = $this->pageHeading = 'CJuiDroppable';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CJuiDroppable';
?>
<div id="nav">
...
<tr>
  <th>Source Code</th>
  <td><a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/zii/widgets/jui/CJuiDroppable.php">yii/zii/widgets/jui/CJuiDroppable.php</a></td>
</tr>
<tr>
  <th>Author</th>
...
<br/><br/>
CJuiDroppable encapsulates the <a href="http://jqueryui.com/droppable/">JUI Droppable</a>
plugin.
<br/><br/>
...
<br/><br/>
By configuring the <?php echo CHtml::link('options', array('/site/doc', 'view' => 'CJuiDroppable', '#' => 'options')); ?> property, you may specify the options
that need to be passed to the JUI Droppable plugin. Please refer to
the <a href="http://api.jqueryui.com/droppable/">JUI Droppable API</a> documentation
for possible options (name-value pairs) and
<a href="http://jqueryui.com/droppable/">JUI Droppable page</a> for general
...
<tr class="inherited" id="actionPrefix">
  ...
  <td>string</td>
  <td>the prefix to the IDs of the <?php echo CHtml::link('actions', array('/site/doc', 'view' => 'CJuiDroppable', '#' => 'actions')); ?>.</td>
...
<tr id="tagName">
  <td><?php echo CHtml::link('tagName', array('/site/doc', 'view' => 'CJuiDroppable', '#' => 'tagName-detail')); ?></td>
  <td>string</td>
  <td>the HTML tag name of the Droppable element.</td>
  <td>CJuiDroppable</td>
</tr>
...
<tr id="init">
  <td><?php echo CHtml::link('init()', array('/site/doc', 'view' => 'CJuiDroppable', '#' => 'init-detail')); ?></td>
  <td>Renders the open tag of the droppable element.</td>
  <td>CJuiDroppable</td>
</tr>
...
<tr id="run">
  <td><?php echo CHtml::link('run()', array('/site/doc', 'view' => 'CJuiDroppable', '#' => 'run-detail')); ?></td>
  <td>Renders the close tag of the droppable element.</td>
  <td>CJuiDroppable</td>
</tr>
...
<tr class="inherited" id="registerScriptFile">
  ...
  <td>Registers a JavaScript file under <?php echo CHtml::link('scriptUrl', array('/site/doc', 'view' => 'CJuiDroppable', '#' => 'scriptUrl')); ?>.</td>
  <td><?php echo CHtml::link('CJuiWidget', array('/site/doc', 'view' => 'CJuiWidget')); ?></td>
</tr>
...
<p>the HTML tag name of the Droppable element. Defaults to 'div'.</p>
...
<div class="sourceCode">
<b>Source Code:</b> <a class="sourceLink" href="https://github.com/yiisoft/yii/blob/master/framework/zii/widgets/jui/CJuiDroppable.php#L74">yii/zii/widgets/jui/CJuiDroppable.php#L74</a> (<b><a href="#" class="show">show</a></b>)
<div class="code"><code><span style="color: #000000">
<span style="color: #0000BB"></span><span style="color: #007700">public&nbsp;function&nbsp;</span><span style="color: #0000BB">run</span><span style="color: #007700">()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;echo&nbsp;</span><span style="color: #0000BB">CHtml</span><span style="color: #007700">::</span><span style="color: #0000BB">closeTag</span><span style="color: #007700">(</span><span style="color: #0000BB">$this</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">tagName</span><span style="color: #007700">);<br />}</span>
</span>
</code></div>
</div>
<p>Renders the close tag of the droppable element.</p>
