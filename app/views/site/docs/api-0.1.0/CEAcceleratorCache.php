<?php
$this->pageTitle = $this->pageHeading = 'CEAcceleratorCache';
$this->breadcrumbs = array();
$this->breadcrumbs[Yii::t('app', 'Documentation')] = array('/site/doc');
$this->breadcrumbs[] = 'CEAcceleratorCache';
?>
<div id="nav">
...
<tr>
  <th>Inheritance</th>
  <td>class CEAcceleratorCache &raquo;
...
CEAcceleratorCache implements a cache application module based on <a href="http://eaccelerator.net/">eaccelerator</a>.
<br/><br/>
To use this application component, the eAccelerator PHP extension must be loaded.
<br/><br/>
See <?php echo CHtml::link('CCache', array('/site/doc', 'view' => 'CCache')); ?> manual for common cache operations that are supported by CEAccelerator.
<br/><br/>
Please note that as of v0.9.6, eAccelerator no longer supports data caching.
This means if you still want to use this component, your eAccelerator should be of 0.9.5.x or lower version.</div>
<a name="properties"></a>
...
<tr id="init">
  <td><?php echo CHtml::link('init()', array('/site/doc', 'view' => 'CEAcceleratorCache', '#' => 'init-detail')); ?></td>
  <td>Initializes this application component.</td>
  <td>CEAcceleratorCache</td>
</tr>
...
<tr id="addValue">
  <td><?php echo CHtml::link('addValue()', array('/site/doc', 'view' => 'CEAcceleratorCache', '#' => 'addValue-detail')); ?></td>
  <td>Stores a value identified by a key into cache if the cache does not contain this key.</td>
  <td>CEAcceleratorCache</td>
</tr>
<tr id="deleteValue">
  <td><?php echo CHtml::link('deleteValue()', array('/site/doc', 'view' => 'CEAcceleratorCache', '#' => 'deleteValue-detail')); ?></td>
  <td>Deletes a value with the specified key from cache</td>
  <td>CEAcceleratorCache</td>
</tr>
<tr id="flushValues">
  <td><?php echo CHtml::link('flushValues()', array('/site/doc', 'view' => 'CEAcceleratorCache', '#' => 'flushValues-detail')); ?></td>
  <td>Deletes all values from cache.</td>
  <td>CEAcceleratorCache</td>
</tr>
...
<tr id="getValue">
  <td><?php echo CHtml::link('getValue()', array('/site/doc', 'view' => 'CEAcceleratorCache', '#' => 'getValue-detail')); ?></td>
  <td>Retrieves a value from cache with a specified key.</td>
  <td>CEAcceleratorCache</td>
</tr>
...
<tr id="setValue">
  <td><?php echo CHtml::link('setValue()', array('/site/doc', 'view' => 'CEAcceleratorCache', '#' => 'setValue-detail')); ?></td>
...
It checks the availability of eAccelerator.</p>
